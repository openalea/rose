...
.. toctree::
    ...
    Notebook examples<user/notebooks.rst>
    Reference Guide<user/autosum.rst>

- A `PDF <../latex/rose.pdf>`_ version of |rose| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:rose:rose>`__ wiki.
