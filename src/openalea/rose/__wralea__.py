...
__all__ = ['DigitReconstruction', 'mesh_roseLeaflet_mesh_roseLeaflet', '_76577232', 'CropGeneration_CropGeneration', '_76576880', 'RoseLpy', 'GetMTG_GetMTG', 'PlantPositionning_PlantPositionning', '_76577360', 'PlantFrame_Rose_PlantFrame_Rose', 'SceneRotation_SceneRotation', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'PlantReconstruction', 'leaflet_orientation_leaflet_orientation']
...
DigitReconstruction = CompositeNodeFactory(name='DigitReconstruction',
   ...
   10019292: (4, 0, 22, 0)},
         ...
         'caption': 'list',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x05074CB0> : "list"',
         'hide': True,
         'id': 2,
         'lazy': True,
   ...
   3: {  'block': False,
         'caption': 'GetMTG',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x04907830> : "GetMTG"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -207.51126551745892,
         'posy': -217.91133183100479,
         'priority': 0,
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x04907A50> : "21052010_BFV.txt"',
         'hide': True,
         'id': 4,
         'lazy': True,
   ...
   5: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x04907910> : "PlantReconstruction"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': "'39'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x04B349B0> : "string"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'X1',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04B52D10> : "X"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          'caption': 'map',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x048FD230> : "map"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'dirname',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04A55810> : "dirname"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   17: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04907930> : "PlantPositionning"',
          'hide': True,
          'id': 17,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0489B0B0> : "plot3D"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'Scene',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x068F8850> : "Scene"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   22: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x049078F0> : "CropGeneration"',
          'hide': True,
          'id': 22,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   23: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04907850> : "mesh_roseLeaflet"',
          'hide': True,
          'id': 23,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   3: {'position': [-207.51126551745892, -217.91133183100479], 'userColor': None, 'useUserColor': False},
   4: {'position': [-21.022245270183205, -265.50317174564702], 'userColor': None, 'useUserColor': False},
   5: {'position': [-215.25177600133591, -141.05576894703779], 'userColor': None, 'useUserColor': False},
   6: {'position': [53.017419433952909, -223.23123972190695], 'userColor': None, 'useUserColor': False},
   ...
   11: {  'position': [-351.18016162511879, 0.67565188120013708],
          'useUserColor': False,
          'userColor': None},
   12: {'position': [-117.32539355120107, -261.74749065286676], 'userColor': None, 'useUserColor': False},
   13: {'useUserColor': True, 'position': [-274.49895904577772, -273.19317801753658], 'userColor': [255, 170, 0]},
   14: {'position': [-47.157709040915272, -45.931099749823353], 'userColor': None, 'useUserColor': False},
   15: {  'position': [-448.66470452042222, -39.444605744642104],
          'useUserColor': False,
          'userColor': None},
   16: {'useUserColor': True, 'position': [-214.82712368317095, -274.34064495770787], 'userColor': [255, 170, 0]},
   17: {'position': [-138.69103813656062, -92.454104177323472], 'userColor': None, 'useUserColor': False},
   18: {'position': [-49.766922760214044, 41.657346363233621], 'userColor': None, 'useUserColor': False},
   ...
   20: {  'position': [-353.39310417493391, 51.511197293391334],
          'useUserColor': False,
          'userColor': None},
   21: {  'position': [-124.60577591890622, -263.87385071815311],
          'useUserColor': False,
          'userColor': None},
   22: {'position': [17.492618262198249, -149.51875697713666], 'userColor': None, 'useUserColor': False},
   23: {'position': [-322.75516743125706, -219.51071905987507], 'userColor': None, 'useUserColor': False},
...
_76577232 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_76576880 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_76577360 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
