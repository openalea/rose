...
@defaultparameters
def I():
      ckresponse_ck_k1_synth_coef     = 803.421171174, 0, 1000
      slresponse_sugar_k1_synth_coef  = 6.6838489915e-14,  0, 1000
      slresponse_sugar_k2_synth_coef  = 6.18151629277,  0, 1000
      I_base_synth_coef               = 0.359995245808, 0, 1000
      I_sl_synthcoef                  = 5.02575901989,  0, 1000
      I_ck_synthcoef                  = 0.000339635986326,  0, 1000
