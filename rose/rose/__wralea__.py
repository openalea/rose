...
# This file has been generated at Fri Oct  7 17:21:49 2011
...
__all__ = ['mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', 'rose_CropGeneration_2011', 'rose_MTG_union', '_61268048', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'PlantReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_VertexVisitor', 'Canopy2011Driver', 'GetLocalFiles', 'DigitReconstruction', 'rose_LocalDir2DictOfFiles', 'ReconstructionWithTurtle_ReconstructionWithTurtle', 'rose_geometry_PolygonLeaflet', 'SceneRotation_SceneRotation', 'CanopyReconstruction2011', 'rose_GridFile2Dict', 'PlantPositionning_PlantPositionning', '_61268624', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', '_61268176', 'GetWebFiles', 'CropGeneration_CropGeneration', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'rose_geometry_NoLeaflet']
...
_61268048 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose', 'Canopy2011Driver')},
                             elt_connections={  6402296: (34, 0, 37, 0),
   6402320: (13, 0, 10, 0),
   6402344: (4, 0, 12, 0),
   6402368: (3, 0, 38, 6),
   6402392: (19, 0, 15, 9),
   ...
   6403040: (29, 0, 7, 2)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3a6e390> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4733350> : "string"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'ReconstructionWithTurtle',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3a6e4d0> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a6e310> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'GetWebFiles',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a6e6d0> : "GetWebFiles"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': '1',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x472e910> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3be46d0> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4721c50> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e1d0> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e650> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e110> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'tuple',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3151e90> : "tuple"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e190> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x472e6d0> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   24: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x28cb750> : "getitem"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   26: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e510> : "PolygonLeaflet"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   28: {  'block': False,
          'caption': 'NoLeaflet',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e5d0> : "NoLeaflet"',
          'hide': True,
          'id': 28,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   32: {  'block': False,
          'caption': 'dict',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2490f10> : "dict"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   37: {  'block': False,
          'caption': 'ComputeLeaflet4pts',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a6e090> : "ComputeLeaflet4pts"',
          'hide': True,
          'id': 37,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a6e3d0> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
...
_61268624 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_61268176 = DataFactory(name='rose.drf',
