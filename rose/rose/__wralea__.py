...
# This file has been generated at Fri Dec  2 11:22:28 2011
...
roseMtgDataDir = CompositeNodeFactory(name='roseMtgDataDir',
      ...
      'interface': IStr,
      'name': 'datadir'}],
                             elt_factory={  2: ('Rose', 'RosePackageDir'),
   3: ('openalea.file', 'parentdir'),
   4: ('openalea.data structure.string', 'string'),
   5: ('openalea.data structure.string', 'string'),
   6: ('openalea.file', 'joinpath')},
                             elt_connections={  6402920: (2, 0, 3, 0),
   6402968: (3, 0, 6, 0),
   6402992: (4, 0, 6, 0),
   6403016: (5, 0, 6, 0),
   6403040: (6, 0, '__out__', 0)},
                             elt_data={  2: {  'block': False,
         'caption': 'RosePackageDir',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x60172d0> : "RosePackageDir"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -72.328158613215862,
         'posy': -47.985443512726363,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   3: {  'block': False,
         'caption': 'parentdir',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3385b50> : "parentdir"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': "'share'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4828510> : "string"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'joinpath',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3385910> : "joinpath"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 23.523221740601016,
                 'posy': 118.01855190865575,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   6: {  'position': [8.7184351893386207, 47.660779035051121],
         ...
         'userColor': None},
   '__in__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None},
   '__out__': {  'position': [23.523221740601016, 118.01855190865575],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
RosePackageDir_RosePackageDir = Factory(name='RosePackageDir',
                authors=' (wralea authors)',
                description='get the actual directory name for the rose package, even in windows',
                category='data i/o',
                nodemodule='RosePackageDir',
                nodeclass='RosePackageDir',
                inputs=[],
                outputs=[{'interface': IStr, 'name': 'dirname', 'desc': 'directory name for the package'}],
                widgetmodule=None,
                widgetclass=None,
               )
...
_121937552 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_121935952 = DataFactory(name='rose.drf',
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose', 'Canopy2011Driver')},
                             elt_connections={  6402344: (30, 0, 21, 0),
   6402368: (30, 0, 10, 1),
   6402392: (36, 0, 38, 2),
   6402416: (38, 1, 6, 0),
   6402440: (31, 0, 38, 0),
   ...
   6403040: (13, 0, 10, 0)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x7449750> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x74497d0> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': '1',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x481fad0> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c52bd0> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4757e10> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x7449510> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x7449a50> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x74494d0> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'ReconstructWithTurtle',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x7449990> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   17: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -297.02263140353716,
          'posy': 40.138193432910441,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x7449690> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x481f890> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3794110> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   21: {  'block': False,
          'caption': 'pickle load',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c52950> : "pickle load"',
          'hide': True,
          'id': 21,
          'lazy': False,
          'port_hide_changed': set(),
          'posx': -301.78338025360262,
          'posy': 151.65009135756046,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   22: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2cff750> : "getitem"',
          'hide': True,
          'id': 22,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   24: {  'block': False,
          'caption': 'drawFlowers',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x7449b10> : "drawFlowers"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   25: {  'block': False,
          'caption': 'drawBuds',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x7449f50> : "drawBuds"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   26: {  'block': False,
          'caption': 'GetOrigin',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x7449a90> : "GetOrigin"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   29: {  'block': False,
          'caption': '4.2',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x481f950> : "float"',
          'hide': True,
          'id': 29,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   30: {  'block': False,
          'caption': 'tempFile',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x7449ed0> : "tempFile"',
          'hide': True,
          'id': 30,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -290.14179824360974,
          'posy': 84.863608972439195,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   32: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x74492d0> : "drawLeaflets"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   34: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x7449bd0> : "roseMtgDataDir"',
          'hide': True,
          'id': 34,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x7449c10> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: [],
   13: [  (  0,
             '[<openalea.mtg.mtg.MTG object at 0x7934110>, <openalea.mtg.mtg.MTG object at 0x7934250>, <openalea.mtg.mtg.MTG object at 0x7934290>, <openalea.mtg.mtg.MTG object at 0x79342d0>, <openalea.mtg.mtg.MTG object at 0x7934310>, <openalea.mtg.mtg.MTG object at 0x7934350>, <openalea.mtg.mtg.MTG object at 0x7934390>, <openalea.mtg.mtg.MTG object at 0x79343d0>, <openalea.mtg.mtg.MTG object at 0x7934410>, <openalea.mtg.mtg.MTG object at 0x7934450>, <openalea.mtg.mtg.MTG object at 0x7934490>, <openalea.mtg.mtg.MTG object at 0x79344d0>, <openalea.mtg.mtg.MTG object at 0x7934510>, <openalea.mtg.mtg.MTG object at 0x7934550>, <openalea.mtg.mtg.MTG object at 0x7934590>, <openalea.mtg.mtg.MTG object at 0x79345d0>, <openalea.mtg.mtg.MTG object at 0x7934610>, <openalea.mtg.mtg.MTG object at 0x7934650>, <openalea.mtg.mtg.MTG object at 0x7934690>, <openalea.mtg.mtg.MTG object at 0x79346d0>, <openalea.mtg.mtg.MTG object at 0x7934710>]')],
   14: [],
   ...
   11: {'position': [-282.24652986025802, -6.6711839043084353], 'userColor': None, 'useUserColor': False},
   ...
   17: {'useUserColor': False, 'position': [-297.02263140353716, 40.138193432910441], 'userColor': None},
   ...
   21: {'useUserColor': False, 'position': [-301.78338025360262, 151.65009135756046], 'userColor': None},
   ...
   30: {'useUserColor': False, 'position': [-290.14179824360974, 84.863608972439195], 'userColor': None},
   ...
   34: {'useUserColor': False, 'position': [-87.33712420225811, -169.33697970326719], 'userColor': None},
   ...
   37: {'position': [-20.610795328170141, -177.3380674084012], 'userColor': None, 'useUserColor': False},
...
_121937296 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
drawBuds = CompositeNodeFactory(name='drawBuds',
   ...
   7: {  'position': [74.966501943182138, -73.076590129488466],
         ...
         'userColor': None},
   '__in__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None},
   '__out__': {  'position': [64.229248063670909, 135.46384564518615],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
