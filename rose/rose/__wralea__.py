...
# This file has been generated at Tue Jun 21 17:17:21 2011
...
__all__ = ['computeLeaflet4pts_computeLeaflet4pts', '_62862352', '_62862160', 'mesh_roseLeaflet_mesh_roseLeaflet', 'PlantPositionning_PlantPositionning', 'DigitReconstruction', 'CropGeneration_CropGeneration', 'tortue_tortue', 'RoseLpy', 'GetMTG_GetMTG', 'CanopyReconstruction', 'VertexVisitor_VertexVisitor', '_62862992', 'leaflet_orientation_leaflet_orientation', 'PlantFrame_Rose_PlantFrame_Rose', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', '_62861904', 'PlantReconstruction', 'SceneRotation_SceneRotation', 'DigitReconstructionWithTurtle_DigitReconstructionWithTurtle']
...
_62862352 = DataFactory(name='test2011OK.mtg',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62862160 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction = CompositeNodeFactory(name='CanopyReconstruction',
   ...
   11: ('Rose', 'rose.drf')},
                             elt_connections={  6402896: (7, 0, 2, 1),
   6402920: (10, 0, 9, 0),
   6402944: (3, 0, 2, 0),
   6402968: (11, 0, 10, 1),
   6402992: (3, 0, 10, 0),
   ...
   6403040: (2, 0, 8, 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3bf3650> : "DigitReconstructionWithTurtle"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'GetMTG',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3bf33d0> : "GetMTG"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': "'test2011OK'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x37f0e50> : "string"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b74990> : "computeLeaflet4pts"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -180.28624192059095,
         'posy': -102.92705447830103,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   7: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3bf3490> : "VertexVisitor"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'plot3D',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x45e6f90> : "plot3D"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 84.081255771006468,
         'posy': 78.83656509695291,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   10: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3bf3550> : "PlantFrame_Rose"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 49.900528355670048,
          'posy': 9.9801056711340124,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   11: {  'block': False,
          'caption': 'rose.drf',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x3bf3690> : "rose.drf"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set([2]),
          'posx': 166.81033764609703,
          'posy': -54.177716500441768,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   5: {'useUserColor': False, 'position': [-17.0, -103.0], 'userColor': None},
   6: {'useUserColor': False, 'position': [-180.28624192059095, -102.92705447830103], 'userColor': None},
...
_62862992 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62861904 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
PlantReconstruction = CompositeNodeFactory(name='PlantReconstruction',
   ...
   6402968: ('__in__', 1, 2, 2),
   6402992: (2, 0, 3, 0),
   6403016: ('__in__', 0, 5, 0),
   6403040: (4, 0, '__out__', 0)},
                             elt_data={  2: {  'block': False,
         'caption': 'leaflet_orientation',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c761d0> : "leaflet_orientation"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': '+',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x2a37990> : "+"',
         'hide': True,
         'id': 3,
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c76250> : "SceneRotation"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   5: {  'block': False,
         'caption': 'PlantFrame_Rose',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c76210> : "PlantFrame_Rose"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'rose.drf',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x3c1afd0> : "rose.drf"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 19.855363799076429,
                'posy': -182.40631935494312,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': -2.3276933926827468,
                 'posy': 73.695005387666484,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   6: {  'position': [69.20545813750195, -128.68916585144234],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [19.855363799076429, -182.40631935494312],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [-2.3276933926827468, 73.695005387666484],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
