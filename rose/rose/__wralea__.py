...
# This file has been generated at Mon Oct  3 15:27:10 2011
...
__all__ = ['mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_GridFile2Dict', 'RoseLpy', 'rose_CropGeneration_2011', 'rose_MTG_union', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'PlantReconstruction', '_60679952', 'rose_Files2MTGs', 'rose_GetMTG', 'Canopy2011Driver', 'GetLocalFiles', 'DigitReconstruction', 'rose_LocalDir2DictOfFiles', 'NoLeaflet_NoLeaflet', 'SceneRotation_SceneRotation', 'computeLeaflet4pts_computeLeaflet4pts', 'CanopyReconstruction2011', 'PlantPositionning_PlantPositionning', '_60679888', '_66572368', 'ReconstructionWithTurtle_ReconstructionWithTurtle', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'GetWebFiles', 'CropGeneration_CropGeneration', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'VertexVisitor_VertexVisitor']
...
_60679952 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose', 'Canopy2011Driver')},
                             elt_connections={  6402440: (14, 0, 15, 0),
   6402464: (7, 0, 15, 1),
   6402488: (33, 0, 38, 3),
   6402512: (3, 0, 38, 6),
   6402536: (36, 0, 38, 4),
   ...
   6403040: (23, 0, 15, 8)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3fe1890> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4726a50> : "string"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'ReconstructionWithTurtle',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3fe1590> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3fe1450> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'GetWebFiles',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3fe1850> : "GetWebFiles"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': '0',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x466bfd0> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3df28d0> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': 'filename',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3326d90> : "filename"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x466b390> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3fe1390> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3fe1250> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3fe12d0> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'tuple',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x314ff50> : "tuple"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3fe1490> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x466bdd0> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -10.49770347873428,
          'posy': -48.655581454513325,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x37341d0> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   23: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 31.158507267609792,
          'posy': -48.75352013438156,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   32: {  'block': False,
          'caption': 'dict',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2876f90> : "dict"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3fe1510> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
...
_60679888 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_66572368 = DataFactory(name='rose.drf',
...
CanopyReconstruction = CompositeNodeFactory(name='CanopyReconstruction',
   ...
   13: ('openalea.python method', 'getitem')},
                             elt_connections={  6402896: (12, 0, 9, 1),
   6402920: (2, 0, 8, 0),
   6402944: (4, 0, 2, 0),
   6402968: (13, 0, 4, 0),
   6402992: (7, 0, 2, 1),
   ...
   6403040: (11, 0, 9, 0)},
         ...
         'caption': 'ReconstructionWithTurtle',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x416c2d0> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'MTG',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3076890> : "MTG"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'computeLeaflet4pts',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x416c150> : "computeLeaflet4pts"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x416c350> : "VertexVisitor"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'plot3D',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x47cab10> : "plot3D"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': 'glob',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x37f7890> : "glob"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'NoLeaflet',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x415ff90> : "NoLeaflet"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': '.../P1',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x37e0ed0> : "dirname"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': "'*.mtg'",
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x36fa350> : "string"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x38eca50> : "getitem"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   9: [],
   10: [],
   11: [(0, "'/mnt/echange/samba/MTG/Manip1_C1_PARfort/P1'")],
   12: [(0, "'*.mtg'")],
   13: [(1, '11')],
   '__in__': [],
   '__out__': []},
         ...
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [-4.9518067753036163, -61.255187546288262],
         'useUserColor': False,
         'userColor': None},
