...
# This file has been generated at Wed Sep 21 09:25:38 2011
...
__all__ = ['httpDir2DictOfFiles_httpDir2DictOfFiles', 'mesh_roseLeaflet_mesh_roseLeaflet', '_117466064', 'MTG_union_MTG_union', 'VertexVisitor_VertexVisitor', 'PlantFrame_Rose_PlantFrame_Rose', 'PlantReconstruction', 'httpFileList_httpFileList', 'DigitReconstruction', 'RoseLpy', 'GetMTG_GetMTG', '_117465424', 'NoLeaflet_NoLeaflet', '_117465200', 'SceneRotation_SceneRotation', 'computeLeaflet4pts_computeLeaflet4pts', 'CanopyReconstruction2011', '_117466096', 'CropGeneration_2011_CropGeneration_2011', 'PlantPositionning_PlantPositionning', '_117465840', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'ReconstructionWithTurtle_ReconstructionWithTurtle', 'GetWebFiles', 'CropGeneration_CropGeneration', 'tortue_tortue', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', '_117465360', '_117465552', 'gridFile2Dict_gridFile2Dict', 'Files2MTGs_Files2MTGs']
...
_117466064 = DataFactory(name='2011-M1-PARfort-P2.txt',
...
_117465424 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_117465200 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   26: ('openalea.math', '+')},
                             elt_connections={  10019016: (23, 0, 18, 1),
   10019028: (14, 0, 15, 0),
   10019040: (4, 0, 12, 0),
   10019052: (26, 0, 14, 0),
   10019064: (16, 0, 15, 7),
   ...
   10019292: (21, 0, 7, 1)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x07006410> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x07006370> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'GetWebFiles',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x07006390> : "GetWebFiles"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04C31B30> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x070060B0> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x07006490> : "gridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x070062B0> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x07006470> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x05103D70> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   5: {'position': [-40.501512509783055, -106.15387076450672], 'userColor': None, 'useUserColor': False},
   6: {  'position': [-100.36344254598362, -17.719346611691591],
         'useUserColor': False,
         'userColor': None},
   7: {'position': [-124.28360664004551, -46.899474203790767], 'userColor': None, 'useUserColor': False},
   8: {'position': [-144.3611723440271, -179.58877546028651], 'userColor': None, 'useUserColor': False},
   ...
   16: {'position': [1.7430844522567739, -62.549630847110549], 'userColor': None, 'useUserColor': False},
   17: {'position': [-167.57409029827852, -106.24713301274005], 'userColor': None, 'useUserColor': False},
   ...
   20: {'position': [-32.557267394119066, -64.033398295774049], 'userColor': None, 'useUserColor': False},
   ...
   23: {'position': [101.83091729921496, 12.062967108981482], 'userColor': None, 'useUserColor': False},
...
_117466096 = DataFactory(name='2011-M1-PARfort-P1.txt',
...
_117465840 = DataFactory(name='2011-M1-PARfort-P3.txt',
...
GetWebFiles = CompositeNodeFactory(name='GetWebFiles',
   ...
   '__in__': {'position': [81.190760997643565, -235.56174382299349], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [53.893109410011519, 189.6015498132038], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_117465360 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_117465552 = DataFactory(name='test2011OK.mtg',
                    description='',
                    editors=None,
                    includes=None,
                    )
