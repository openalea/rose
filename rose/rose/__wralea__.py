...
# This file has been generated at Wed Sep 21 15:04:15 2011
...
__all__ = ['httpDir2DictOfFiles_httpDir2DictOfFiles', 'mesh_roseLeaflet_mesh_roseLeaflet', 'MTG_union_MTG_union', '_62164752', 'PlantFrame_Rose_PlantFrame_Rose', '_62386640', 'PlantReconstruction', 'httpFileList_httpFileList', 'LocalDir2DictOfFiles_LocalDir2DictOfFiles', 'GetLocalFiles', 'DigitReconstruction', 'RoseLpy', 'GetMTG_GetMTG', 'NoLeaflet_NoLeaflet', '_62387088', 'SceneRotation_SceneRotation', 'CropGeneration_2011_CropGeneration_2011', 'computeLeaflet4pts_computeLeaflet4pts', 'CanopyReconstruction2011', 'PlantPositionning_PlantPositionning', '_62387664', '_62386384', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'ReconstructionWithTurtle_ReconstructionWithTurtle', '_62386960', 'GetWebFiles', 'CropGeneration_CropGeneration', 'tortue_tortue', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'VertexVisitor_VertexVisitor', '_62387280', 'gridFile2Dict_gridFile2Dict', 'Files2MTGs_Files2MTGs']
...
_62164752 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62386640 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
GetLocalFiles = CompositeNodeFactory(name='GetLocalFiles',
   ...
   9: {  'position': [-44.807248015563559, -30.86226323142488],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [45.890689011599875, 30.976215082829917],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [87.432645420181956, -187.44573803071071],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [93.449003948293822, 92.357950573439552],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
_62387088 = DataFactory(name='2011-M1-PARfort-P2.txt',
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   29: ('openalea.data structure.string', 'string')},
                             elt_connections={  6402416: (20, 0, 15, 2),
   6402440: (16, 0, 15, 7),
   6402464: (28, 0, 6, 0),
   6402488: (29, 0, 7, 2),
   6402512: (3, 0, 28, 0),
   ...
   6403040: (24, 0, 22, 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b7f590> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -271.30742667927996,
         'posy': -180.96118595253881,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b7f3d0> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3b7f050> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'GetWebFiles',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3b7f410> : "GetWebFiles"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -147.80498888264407,
         'posy': -236.09777094506919,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   9: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -277.8914899005789,
         'posy': -259.80644223388998,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x46d75d0> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b48e50> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b7f610> : "gridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b7f2d0> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'tuple',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c8d510> : "tuple"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 6.2025489686071573,
          'posy': -44.711772781709008,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   17: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -272.7615428204623,
          'posy': -139.61690061326772,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b7f650> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2f2dc90> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 66.071615765390035,
          'posy': -75.026741689257094,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x46d7890> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   22: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -372.03463094046924,
          'posy': -117.44375553867341,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   23: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 69.421637610835859,
          'posy': -32.47443306225226,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   24: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -457.39506373732581,
          'posy': -215.39598656931412,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   27: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -107.13669524136016,
          'posy': -180.64950340826098,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   28: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -144.36869134557702,
          'posy': -142.76578007759653,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   29: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -172.57584223101588,
          'posy': -79.148990154557737,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   3: {'useUserColor': False, 'position': [-271.30742667927996, -180.96118595253881], 'userColor': None},
   ...
   8: {'useUserColor': False, 'position': [-147.80498888264407, -236.09777094506919], 'userColor': None},
   9: {'useUserColor': False, 'position': [-277.8914899005789, -259.80644223388998], 'userColor': None},
   ...
   16: {'useUserColor': False, 'position': [6.2025489686071573, -44.711772781709008], 'userColor': None},
   17: {'useUserColor': False, 'position': [-272.7615428204623, -139.61690061326772], 'userColor': None},
   18: {'useUserColor': False, 'position': [-108.87049973427234, 69.281227103627842], 'userColor': None},
   19: {'useUserColor': False, 'position': [66.071615765390035, -75.026741689257094], 'userColor': None},
   20: {'useUserColor': False, 'position': [-26.611314705651889, -41.736075714022128], 'userColor': None},
   21: {'position': [-89.395689058755394, -104.88717358817976], 'userColor': None, 'useUserColor': False},
   22: {'useUserColor': False, 'position': [-372.03463094046924, -117.44375553867341], 'userColor': None},
   23: {'useUserColor': False, 'position': [69.421637610835859, -32.47443306225226], 'userColor': None},
   24: {'useUserColor': False, 'position': [-457.39506373732581, -215.39598656931412], 'userColor': None},
   ...
   27: {'useUserColor': False, 'position': [-107.13669524136016, -180.64950340826098], 'userColor': None},
   28: {'useUserColor': False, 'position': [-144.36869134557702, -142.76578007759653], 'userColor': None},
   29: {'useUserColor': False, 'position': [-172.57584223101588, -79.148990154557737], 'userColor': None},
...
_62387664 = DataFactory(name='2011-M1-PARfort-P1.txt',
...
_62386384 = DataFactory(name='2011-M1-PARfort-P3.txt',
...
_62386960 = DataFactory(name='test2011OK.mtg',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62387280 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
