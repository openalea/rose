...
# This file has been generated at Tue Nov 29 17:20:04 2011
...
__all__ = ['drawLeaflets', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', '_116566096', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'DigitReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', 'GetLocalFiles', 'PlantReconstruction', 'rose_LocalDir2DictOfFiles', '_116566608', 'rose_geometry_PolygonLeaflet', 'SceneRotation_SceneRotation', 'rose_geometry_PetalMatrix', 'rose_geometry_ReconstructWithTurtle', 'testRevolutionFig', '_116566224', 'CanopyReconstruction2011', 'PlantPositionning_PlantPositionning', 'revolutiontestinonefile_revolutiontestinonefile', 'rose_geometry_BuiltBud', 'drawFlowers', 'rose_GridFile2Dict', 'rose_geometry_RawFlower', 'rose_geometry_NoOrgan', 'rose_GetOrigin', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'rose_geometry_RevolutionBud', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', 'GetWebFiles', 'Canopy2011Driver', 'CropGeneration_CropGeneration', 'rose_geometry_BudArray', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'rose_colors_ColorFuncs', 'testRevolutionFigCompositeNode', 'rose_geometry_FineBudArray', 'drawBuds', 'rose_geometry_TaperedFlower']
...
_116566096 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_116566608 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_116566224 = DataFactory(name='rose.drf',
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose', 'Canopy2011Driver')},
                             elt_connections={  10018348: (20, 0, 15, 2),
   10018360: (29, 0, 16, 2),
   10018372: (23, 0, 15, 8),
   10018384: (33, 0, 38, 1),
   10018396: (11, 0, 10, 1),
   ...
   10018684: (9, 0, 38, 3)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x06F2A810> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x06F2A710> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': '1',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x04C28510> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0703F2D0> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': 'filename',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04ABFE70> : "filename"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04C28B70> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x06F2A650> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x06F2A9F0> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x06F2A6B0> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'ReconstructWithTurtle',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x06F2A970> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x06F2A730> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04C283F0> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x049400F0> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   21: {  'block': False,
          'caption': 'pickle load',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0703F210> : "pickle load"',
          'hide': True,
          'id': 21,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   22: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0703FC10> : "getitem"',
          'hide': True,
          'id': 22,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   24: {  'block': False,
          'caption': 'drawFlowers',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x06F2AA30> : "drawFlowers"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   25: {  'block': False,
          'caption': 'drawBuds',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x06F2ABD0> : "drawBuds"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   26: {  'block': False,
          'caption': 'GetOrigin',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x06F2AAB0> : "GetOrigin"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   29: {  'block': False,
          'caption': '4.2',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04C28450> : "float"',
          'hide': True,
          'id': 29,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   32: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x06F2A5D0> : "drawLeaflets"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   35: {  'block': False,
          'caption': u'.../MTG',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04ABFB90> : "dirname"',
          'hide': True,
          'id': 35,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x06F2AA10> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   32: [],
   33: [(0, '1')],
   35: [(0, "'D:/SurSamba/openaleapkg/rose/share/MTG'")],
   36: [(0, "['P1', 'P2', 'P3']")],
   37: [(0, "'Z:/'")],
   38: [],
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'position': [-496.796686463377, 90.239943170026834], 'userColor': None, 'useUserColor': False},
   ...
   10: {'position': [-125.017899940067, 139.30761531753856], 'userColor': None, 'useUserColor': False},
   11: {'position': [-44.857785842759284, 101.12853560122247], 'userColor': None, 'useUserColor': False},
   12: {'position': [-441.9112877703991, 203.07150560728525], 'userColor': None, 'useUserColor': False},
   ...
   16: {'position': [-490.63679628764532, 150.60314130651946], 'userColor': None, 'useUserColor': False},
   ...
   21: {'position': [-293.75574156702049, 90.8693984448675], 'userColor': None, 'useUserColor': False},
   22: {'position': [-391.75700637781131, 7.5194778419568209], 'userColor': None, 'useUserColor': False},
   23: {'position': [-23.417190233291279, -49.085123923019154], 'userColor': None, 'useUserColor': False},
   24: {'position': [-411.12779888995044, -34.664013932607062], 'userColor': None, 'useUserColor': False},
   25: {'position': [-495.07146551251287, -34.607948060386491], 'userColor': None, 'useUserColor': False},
   26: {'position': [-108.55953911314603, -11.158327328125409], 'userColor': None, 'useUserColor': False},
   27: {'position': [-586.22939308391108, 4.6087483684011907], 'userColor': None, 'useUserColor': False},
   28: {'position': [-482.77034788964897, 5.3782253862518665], 'userColor': None, 'useUserColor': False},
   29: {'position': [-402.80085488743174, 89.492450951661084], 'userColor': None, 'useUserColor': False},
   ...
   32: {'position': [-607.29382260678028, -32.204975441268658], 'userColor': None, 'useUserColor': False},
