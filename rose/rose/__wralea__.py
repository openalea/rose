...
# This file has been generated at Thu Nov  3 10:09:35 2011
...
__all__ = ['_86921552', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'DigitReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', 'GetLocalFiles', 'PlantReconstruction', '_86921424', 'rose_LocalDir2DictOfFiles', 'PlantPositionning_PlantPositionning', 'rose_geometry_PolygonLeaflet', 'SceneRotation_SceneRotation', 'rose_geometry_ReconstructWithTurtle', 'rose_geometry_drawLeaves', 'testRevolutionFig', '_86921488', 'CanopyReconstruction2011', 'rose_geometry_BuiltBud', 'rose_GridFile2Dict', 'rose_geometry_NoOrgan', 'rose_GetOrigin', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'rose_geometry_RevolutionBud', 'rose_geometry_drawFlowers', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', 'GetWebFiles', 'Canopy2011Driver', 'rose_geometry_drawBuds', 'CropGeneration_CropGeneration', 'rose_geometry_BudArray', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'rose_geometry_RawFlower']


_86921552 = DataFactory(name='rose.drf',
...
_86921424 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
rose_geometry_drawLeaves = Factory(name='drawLeaves',
                authors=' (rose authors)',
                description='allow to select a drawing function',
                category='data processing',
                nodemodule='rose_geometry',
                nodeclass='drawLeaves',
                inputs=[{}],
                outputs=[{'interface': ISequence, 'name': 'leavesComputers', 'desc': 'a function that draws a leaflet'}],
                widgetmodule=None,
                widgetclass=None,
               )
...
_86921488 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose', 'Canopy2011Driver')},
                             elt_connections={  6402368: (2, 0, 16, 1),
   6402392: (27, 0, 2, 0),
   6402416: (15, 0, 18, 0),
   6402440: (9, 0, 38, 3),
   6402464: (22, 0, 2, 2),
   ...
   6403040: (13, 0, 10, 0)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x520afd0> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4726cd0> : "string"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x520af10> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': '2',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x47262d0> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3bdffd0> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4719610> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x520add0> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x52e5410> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -207.66202122307388,
          'posy': -68.07377797439328,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x520ad50> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'ReconstructWithTurtle',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x52e5290> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x520ad90> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4719d90> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   21: {  'block': False,
          'caption': 'pickle load',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3bdfd90> : "pickle load"',
          'hide': True,
          'id': 21,
          'lazy': False,
          'port_hide_changed': set(),
          'posx': -299.49225281749648,
          'posy': 82.838282694201126,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   22: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2858750> : "getitem"',
          'hide': True,
          'id': 22,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -407.81923787914411,
          'posy': 6.3721755918616232,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   24: {  'block': False,
          'caption': 'drawFlowers',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x52e5550> : "drawFlowers"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -427.19003039128319,
          'posy': -35.811316182702257,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   25: {  'block': False,
          'caption': 'drawBuds',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x52e5390> : "drawBuds"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -511.13369701384562,
          'posy': -35.755250310481685,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   26: {  'block': False,
          'caption': 'GetOrigin',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x52e5490> : "GetOrigin"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   27: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -602.29162458524388,
          'posy': 3.461446118305993,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   28: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -498.83257939098172,
          'posy': 4.2309231361566688,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   29: {  'block': False,
          'caption': '4.2',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4726150> : "float"',
          'hide': True,
          'id': 29,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -363.6948132801769,
          'posy': 88.342273257330064,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   32: {  'block': False,
          'caption': 'drawLeaves',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x52e52d0> : "drawLeaves"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -619.59885517677367,
          'posy': -35.76827655582867,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x52e5350> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {'useUserColor': False, 'position': [-207.66202122307388, -68.07377797439328], 'userColor': None},
   ...
   21: {'useUserColor': False, 'position': [-299.49225281749648, 82.838282694201126], 'userColor': None},
   22: {'useUserColor': False, 'position': [-407.81923787914411, 6.3721755918616232], 'userColor': None},
   23: {'useUserColor': False, 'position': [-23.417190233291279, -49.085123923019154], 'userColor': None},
   24: {'useUserColor': False, 'position': [-427.19003039128319, -35.811316182702257], 'userColor': None},
   25: {'useUserColor': False, 'position': [-511.13369701384562, -35.755250310481685], 'userColor': None},
   26: {'useUserColor': False, 'position': [-108.55953911314603, -11.158327328125409], 'userColor': None},
   27: {'useUserColor': False, 'position': [-602.29162458524388, 3.461446118305993], 'userColor': None},
   28: {'useUserColor': False, 'position': [-498.83257939098172, 4.2309231361566688], 'userColor': None},
   29: {'useUserColor': False, 'position': [-363.6948132801769, 88.342273257330064], 'userColor': None},
   ...
   32: {'useUserColor': False, 'position': [-619.59885517677367, -35.76827655582867], 'userColor': None},
...
rose_geometry_drawFlowers = Factory(name='drawFlowers',
                authors=' (rose authors)',
                description='allow to select a bud drawing function',
                category='data processing',
                nodemodule='rose_geometry',
                nodeclass='drawFlowers',
                inputs=[{}],
                outputs=[{'interface': ISequence, 'name': 'flowersComputers', 'desc': 'a function that draws a flower'}],
                widgetmodule=None,
                widgetclass=None,
               )
...
rose_geometry_drawBuds = Factory(name='drawBuds',
                authors=' (rose authors)',
                description='allow to select a bud drawing function',
                category='data processing',
                nodemodule='rose_geometry',
                nodeclass='drawBuds',
                inputs=[{}],
                outputs=[{'interface': ISequence, 'name': 'budsComputers', 'desc': 'a function that draws a bud'}],
                widgetmodule=None,
                widgetclass=None,
               )
