...
# This file has been generated at Wed Feb 29 15:59:55 2012
...
__all__ = ['drawLeaflets', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'roseMtgDataDir', '_60778960', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', '_60779088', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'DigitReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', 'GetLocalFiles', 'PlantReconstruction', 'rose_LocalDir2DictOfFiles', 'PlantPositionning_PlantPositionning', 'rose_geometry_PolygonLeaflet', '_60779600', 'rose_geometry_RawFruit', 'SceneRotation_SceneRotation', 'rose_geometry_PetalMatrix', 'rose_geometry_ReconstructWithTurtle', 'testRevolutionFig', 'CanopyReconstruction2011', 'rose_GridFile2Dict', 'revolutiontestinonefile_revolutiontestinonefile', 'rose_geometry_BuiltBud', 'drawFlowers', '_60778832', 'rose_geometry_RawFlower', 'InputsToRoseLpy_InputsToRoseLpy', 'rose_GetOrigin', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'rose_geometry_RevolutionBud', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', 'GetWebFiles', 'Canopy2011Driver', 'rose_geometry_NoOrgan', '_60780176', '_60780368', 'rose_geometry_TaperedFlower', '_59739536', 'rose_geometry_BudArray', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'testRevolutionFigCompositeNode', 'rose_geometry_FineBudArray', 'drawBuds', 'CropGeneration_CropGeneration']
...
_60778960 = DataFactory(name='inputsperphyto.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
RoseLpy = CompositeNodeFactory(name='RoseLpy',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [-156.78401254492667, -166.34791212705576],
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [-66.401926413695676, -168.96868505489391],
         'useUserColor': False,
         'userColor': None},
   4: {  'position': [59.908377485374842, -170.36803712816717],
         'useUserColor': False,
         'userColor': None},
   5: {  'position': [7.1322270786573938, -126.88932473399814],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [126.33288194622818, -139.91759654651531],
         'useUserColor': False,
         'userColor': None},
   7: {  'position': [-119.23199571746592, -49.285713005357202],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [53.020378126557901, -36.06914964213793],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [62.835855360103267, -68.465802326082652],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [115.31479529767452, -6.8806151915920815],
          'useUserColor': False,
          'userColor': None},
   11: {  'position': [50.181612617127399, 53.882508709638486],
          'useUserColor': False,
          'userColor': None},
   12: {  'position': [-4.4185712589575274, 85.272421798339067],
          'useUserColor': False,
          'userColor': None},
   13: {  'position': [-4.4006104676199662, 4.8005091345957336],
          'useUserColor': False,
          'userColor': None},
...
_60779088 = DataFactory(name='rose.drf',
...
_60779600 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   11: {'useUserColor': False, 'position': [190.95166190370927, -16.773460179630476], 'userColor': None},
...
_60778832 = DataFactory(name='growRose.lpy',
...
_60780176 = DataFactory(name='inputsperphyto2plt.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_60780368 = DataFactory(name='inputsperplant.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_59739536 = DataFactory(name='inputsperplant2plt.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
