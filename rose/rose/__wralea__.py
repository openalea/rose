...
# This file has been generated at Wed Jul  6 10:02:29 2011
...
__all__ = ['computeLeaflet4pts_computeLeaflet4pts', '_62790864', '_62791120', '_62653904', 'mesh_roseLeaflet_mesh_roseLeaflet', 'PlantPositionning_PlantPositionning', 'PlantReconstruction', 'CropGeneration_CropGeneration', 'tortue_tortue', 'RoseLpy', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'VertexVisitor_VertexVisitor', 'NoLeaflet_NoLeaflet', 'GetMTG_GetMTG', 'PlantFrame_Rose_PlantFrame_Rose', '_62791056', 'SceneRotation_SceneRotation', 'DigitReconstruction', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'DigitReconstructionWithTurtle_DigitReconstructionWithTurtle']
...
_62790864 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62791120 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62653904 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction = CompositeNodeFactory(name='CanopyReconstruction',
   ...
   10: ('Rose', 'NoLeaflet')},
                             elt_connections={  6402920: (10, 0, 7, 0),
   6402944: (2, 0, 8, 0),
   6402968: (7, 0, 2, 1),
   6402992: (3, 0, 2, 0),
   6403016: (4, 0, 3, 1),
   6403040: (5, 0, 3, 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c46150> : "DigitReconstructionWithTurtle"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'GetMTG',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c37fd0> : "GetMTG"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': "'178'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x386ca90> : "string"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c18610> : "computeLeaflet4pts"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c37f10> : "VertexVisitor"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'plot3D',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x472df10> : "plot3D"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'NoLeaflet',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c37f50> : "NoLeaflet"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [-143.19761082930773, 32.683023197496304],
         'useUserColor': False,
         'userColor': None},
   ...
   5: {  'position': [-83.206803928010771, -143.04116205380217],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [-172.84787961219348, -103.60326923360991],
         'useUserColor': False,
         'userColor': None},
   ...
   9: {  'position': [-249.09077190061828, -141.87694451297355],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [-65.120829380723791, -81.401036725904731],
          'useUserColor': False,
          'userColor': None},
...
_62791056 = DataFactory(name='test2011OK.mtg',
                    description='',
                    editors=None,
                    includes=None,
                    )
