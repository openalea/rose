...
# This file has been generated at Mon Sep 19 09:35:01 2011
...
__all__ = ['mesh_roseLeaflet_mesh_roseLeaflet', 'MTG_union_MTG_union', '_62861072', '_63140176', '_62860816', 'PlantFrame_Rose_PlantFrame_Rose', 'PlantReconstruction', '_63140240', 'DigitReconstruction', 'RoseLpy', 'GetMTG_GetMTG', '_63140560', 'NoLeaflet_NoLeaflet', 'SceneRotation_SceneRotation', 'computeLeaflet4pts_computeLeaflet4pts', 'CanopyReconstruction2011', 'PlantPositionning_PlantPositionning', 'CropGeneration_2011_CropGeneration_2011', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'ReconstructionWithTurtle_ReconstructionWithTurtle', '_62860944', '_63140368', 'CropGeneration_CropGeneration', 'tortue_tortue', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'VertexVisitor_VertexVisitor', 'gridFile2Dict_gridFile2Dict', 'Files2MTGs_Files2MTGs']
...
_62861072 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_63140176 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62860816 = DataFactory(name='2011-M1-PARfort-P1.txt',
...
_63140240 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_63140560 = DataFactory(name='2011-M1-PARfort-P3.txt',
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   26: ('openalea.math', '+')},
                             elt_connections={  6402488: (19, 0, 18, 1),
   6402512: (19, 0, 15, 8),
   6402536: (24, 0, 22, 0),
   6402560: (3, 0, 14, 0),
   6402584: (5, 0, 7, 0),
   ...
   6403040: (16, 0, 15, 7)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c37350> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x3bf2e10> : "2011-M1-PARfort-P1.txt"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3c37390> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x472c290> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3bf2e50> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c37510> : "gridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c37290> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'tuple',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3d323d0> : "tuple"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c37550> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x472c550> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   21: {  'block': False,
          'caption': '+',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2889690> : "+"',
          'hide': True,
          'id': 21,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   23: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 61.781359492501878,
          'posy': 52.112524915694578,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   3: {'position': [-299.24334664653321, -24.63613802805655], 'userColor': None, 'useUserColor': False},
   4: {'position': [-290.99251516508514, 147.27860016544926], 'userColor': None, 'useUserColor': False},
   5: {'position': [-21.688673354504985, -153.89598993338174], 'userColor': None, 'useUserColor': False},
   6: {'position': [-91.9344018388324, -17.719346611691591], 'userColor': None, 'useUserColor': False},
   7: {'position': [-100.8054619208411, -64.911537809193192], 'userColor': None, 'useUserColor': False},
   8: {'position': [-182.83848968845868, -153.73429448585497], 'userColor': None, 'useUserColor': False},
   9: {'position': [-179.81846700804311, -111.70687957325626], 'userColor': None, 'useUserColor': False},
   ...
   14: {'position': [-239.28776692040805, 22.480601171156358], 'userColor': None, 'useUserColor': False},
   ...
   21: {'position': [-103.33748240030927, -109.65662338721481], 'userColor': None, 'useUserColor': False},
   22: {'position': [-297.10930219041825, -115.0268094499621], 'userColor': None, 'useUserColor': False},
   23: {'position': [61.781359492501878, 52.112524915694578], 'userColor': None, 'useUserColor': False},
   24: {'position': [-363.72930674789956, -163.35956243959708], 'userColor': None, 'useUserColor': False},
   25: {'position': [-258.81269394450356, -113.82322816912345], 'userColor': None, 'useUserColor': False},
   26: {'position': [-271.33847237436862, -71.571686567463615], 'userColor': None, 'useUserColor': False},
...
_62860944 = DataFactory(name='test2011OK.mtg',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_63140368 = DataFactory(name='2011-M1-PARfort-P2.txt',
