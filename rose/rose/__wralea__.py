...
# This file has been generated at Wed Feb 29 14:24:15 2012
...
__all__ = ['drawLeaflets', '_119079216', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', 'roseMtgDataDir', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'rose_geometry_RevolutionBud', 'DigitReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', '_119079120', 'PlantReconstruction', 'rose_LocalDir2DictOfFiles', 'PlantPositionning_PlantPositionning', '_119079024', 'rose_geometry_RawFruit', 'SceneRotation_SceneRotation', 'rose_geometry_PetalMatrix', 'rose_geometry_ReconstructWithTurtle', 'testRevolutionFig', '_119079472', 'CanopyReconstruction2011', 'rose_GridFile2Dict', 'revolutiontestinonefile_revolutiontestinonefile', 'rose_geometry_BuiltBud', 'drawFlowers', '_119080144', 'rose_geometry_RawFlower', 'InputsToRoseLpy_InputsToRoseLpy', 'rose_GetOrigin', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', '_118386608', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', '_118386320', 'GetWebFiles', 'Canopy2011Driver', 'rose_geometry_NoOrgan', 'rose_geometry_TaperedFlower', 'GetLocalFiles', 'rose_geometry_BudArray', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'rose_geometry_PolygonLeaflet', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'testRevolutionFigCompositeNode', 'rose_geometry_FineBudArray', 'drawBuds', 'CropGeneration_CropGeneration']
...
_119079216 = DataFactory(name='inputsperplant2plt.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
RoseLpy = CompositeNodeFactory(name='RoseLpy',
   ...
   14: ('vplants.plantgl.visualization', 'plot3D')},
                             elt_connections={  11325248: (14, 0, 11, 1),
   11325260: (4, 0, 5, 1),
   11325272: (2, 0, 8, 0),
   11325284: (8, 1, 10, 1),
   11325296: (13, 0, 12, 1),
   ...
   11325428: (8, 0, 10, 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x071900D0> : "growRose.lpy"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set([2]),
         'posx': -156.78401254492667,
         'posy': -166.34791212705576,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   3: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x070E6FB0> : "inputsperphyto2plt.csv"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x07190130> : "inputsperplant2plt.csv"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   5: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x07190410> : "InputsToRoseLpy"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 7.1322270786573938,
         'posy': -126.88932473399814,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   6: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 126.33288194622818,
         'posy': -139.91759654651531,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   7: {  'block': False,
         'caption': 'RunLpy',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0531DA10> : "RunLpy"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -119.23199571746592,
         'posy': -49.285713005357202,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   9: {  'block': False,
         'caption': 'X0',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x071BCB70> : "X"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x05290910> : "generateScene"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': 'rendez vous',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x071BCA30> : "rendez vous"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'for',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x071BCD30> : "for"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'range',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x07316E90> : "range"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'useUserColor': False, 'position': [-156.78401254492667, -166.34791212705576], 'userColor': None},
   ...
   5: {'useUserColor': False, 'position': [7.1322270786573938, -126.88932473399814], 'userColor': None},
   6: {'useUserColor': False, 'position': [126.33288194622818, -139.91759654651531], 'userColor': None},
   7: {'useUserColor': False, 'position': [-119.23199571746592, -49.285713005357202], 'userColor': None},
...
_119079120 = DataFactory(name='growRose.lpy',
...
_119079024 = DataFactory(name='rose.drf',
...
_119079472 = DataFactory(name='inputsperphyto.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose', 'Canopy2011Driver')},
                             elt_connections={  6402272: (11, 0, 2, 2),
   6402296: (35, 0, 2, 4),
   6402320: (15, 0, 18, 0),
   6402344: (28, 0, 2, 1),
   6402368: (38, 3, 26, 0),
   ...
   6403040: (6, 0, 15, 1)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3a4ff90> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a5e110> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': '2',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4782a50> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b91a10> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': 'PolygonLeaflet',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a5e210> : "PolygonLeaflet"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 241.88436438148898,
          'posy': -137.56019195741172,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x477bd90> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a4fe50> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a5e3d0> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a4fe10> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'ReconstructWithTurtle',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a5e310> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   17: {  'block': False,
          'caption': "'canopy.pf'",
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x478c490> : "string"',
          'hide': True,
          'id': 17,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a4fc90> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4782810> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x36d9e10> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   21: {  'block': False,
          'caption': 'pickle load',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b91790> : "pickle load"',
          'hide': True,
          'id': 21,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   22: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2829610> : "getitem"',
          'hide': True,
          'id': 22,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 280.15165854087894,
          'posy': -54.161204283183217,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   24: {  'block': False,
          'caption': 'drawFlowers',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a5e490> : "drawFlowers"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 259.85764326392496,
          'posy': -97.267918822561981,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   25: {  'block': False,
          'caption': 'drawBuds',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a5e9d0> : "drawBuds"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 175.91397664136258,
          'posy': -97.211852950341381,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   26: {  'block': False,
          'caption': 'GetOrigin',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a5e410> : "GetOrigin"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   27: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 97.597875714057693,
          'posy': -57.995156521553668,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   28: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 188.21509426422648,
          'posy': -57.225679503702992,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   29: {  'block': False,
          'caption': '4.20',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x47828d0> : "float"',
          'hide': True,
          'id': 29,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   30: {  'block': False,
          'caption': 'tempFile',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a5e750> : "tempFile"',
          'hide': True,
          'id': 30,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   32: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3952c90> : "drawLeaflets"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 76.533446191188489,
          'posy': -94.808880331223492,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   34: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a5e550> : "roseMtgDataDir"',
          'hide': True,
          'id': 34,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   35: {  'block': False,
          'caption': 'RawFruit',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a5e250> : "RawFruit"',
          'hide': True,
          'id': 35,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 313.89574003704678,
          'posy': -19.387678061111721,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   37: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 197.37407362698363,
          'posy': -141.55039204262832,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a5e6d0> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   5: {  'position': [35.499866797311142, -157.71453993256128],
         'useUserColor': False,
         'userColor': None},
   6: {'position': [-183.23607851764464, -39.432107597052607], 'userColor': None, 'useUserColor': False},
   ...
   8: {  'position': [-396.67021921519785, -119.93966462628714],
         'useUserColor': False,
         'userColor': None},
   9: {'position': [-117.4198895575162, -168.06928299705677], 'userColor': None, 'useUserColor': False},
   10: {'position': [-27.650826342126521, 123.00747936130651], 'userColor': None, 'useUserColor': False},
   11: {'position': [241.88436438148898, -137.56019195741172], 'userColor': None, 'useUserColor': False},
   ...
   14: {'position': [-206.5147189729787, -71.515684724678863], 'userColor': None, 'useUserColor': False},
   ...
   19: {'position': [17.886847377399079, -48.422732006904937], 'userColor': None, 'useUserColor': False},
   20: {'position': [-140.83518631861594, -9.7981852050721443], 'userColor': None, 'useUserColor': False},
   21: {'position': [62.443561002532476, 122.60557969714034], 'userColor': None, 'useUserColor': False},
   22: {'position': [280.15165854087894, -54.161204283183217], 'userColor': None, 'useUserColor': False},
   23: {'position': [-23.417190233291279, -49.085123923019154], 'userColor': None, 'useUserColor': False},
   24: {'position': [259.85764326392496, -97.267918822561981], 'userColor': None, 'useUserColor': False},
   25: {'position': [175.91397664136258, -97.211852950341381], 'userColor': None, 'useUserColor': False},
   26: {'position': [-108.55953911314603, -11.158327328125409], 'userColor': None, 'useUserColor': False},
   27: {'position': [97.597875714057693, -57.995156521553668], 'userColor': None, 'useUserColor': False},
   28: {'position': [188.21509426422648, -57.225679503702992], 'userColor': None, 'useUserColor': False},
   ...
   31: {'position': [-205.13710122354044, -168.01474097730252], 'userColor': None, 'useUserColor': False},
   32: {'position': [76.533446191188489, -94.808880331223492], 'userColor': None, 'useUserColor': False},
   33: {'position': [-175.08840042648799, -167.82340298227959], 'userColor': None, 'useUserColor': False},
   34: {'position': [-87.33712420225811, -169.33697970326719], 'userColor': None, 'useUserColor': False},
   35: {'position': [313.89574003704678, -19.387678061111721], 'userColor': None, 'useUserColor': False},
   36: {'position': [-152.35691860731836, -168.11283119502784], 'userColor': None, 'useUserColor': False},
   37: {'position': [197.37407362698363, -141.55039204262832], 'userColor': None, 'useUserColor': False},
   38: {'position': [-206.50988739491825, -114.53730161112151], 'userColor': None, 'useUserColor': False},
...
_61202768 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_119080144 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_118386608 = DataFactory(name='inputsperphyto2plt.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_118386320 = DataFactory(name='inputsperplant.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
