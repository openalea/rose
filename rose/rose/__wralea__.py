...
# This file has been generated at Fri Dec 02 13:03:35 2011
...
_75710672 = DataFactory(name='rose.drf',
...
roseMtgDataDir = CompositeNodeFactory(name='roseMtgDataDir',
   ...
   8: ('openalea.data structure.string', 'string')},
                             elt_connections={  9988216: (8, 0, 7, 0),
   9988228: (6, 0, '__out__', 0),
   9988240: (5, 0, 6, 0),
   9988252: (4, 0, 6, 0),
   9988264: (3, 0, 6, 0),
   9988276: (7, 0, 3, 0)},
         ...
         'caption': 'parentdir',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0335E830> : "parentdir"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'joinpath',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0335E890> : "joinpath"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'packagedir',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0335E9F0> : "packagedir"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -58.112058758658833,
         'posy': -50.534801864122954,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -44.02703478242168,
         'posy': -81.059052789306577,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 19.611020680558617,
                 'posy': 90.060740078965182,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   '__out__': []},
         ...
         'useUserColor': False,
         'userColor': None},
   3: {'position': [-53.848928591668674, -12.088534989966435], 'userColor': None, 'useUserColor': False},
   4: {'position': [54.054298173899454, -5.2310611136031717], 'userColor': None, 'useUserColor': False},
   5: {'position': [122.63932166336326, -9.8808932145837698], 'userColor': None, 'useUserColor': False},
   6: {'position': [8.7184351893386207, 47.660779035051121], 'userColor': None, 'useUserColor': False},
   7: {'useUserColor': False, 'position': [-58.112058758658833, -50.534801864122954], 'userColor': None},
   8: {'useUserColor': False, 'position': [-44.02703478242168, -81.059052789306577], 'userColor': None},
   '__in__': {'position': [0, 0], 'userColor': None, 'useUserColor': True},
   '__out__': {'position': [19.611020680558617, 90.060740078965182], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_74956432 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   9: {  'position': [-117.4198895575162, -168.06928299705677],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [-27.650826342126521, 123.00747936130652],
          'useUserColor': False,
          'userColor': None},
   11: {  'position': [-282.24652986025802, -6.6711839043084353],
          'useUserColor': False,
          'userColor': None},
   12: {  'position': [190.00874726093673, 134.04668739528375],
          'useUserColor': False,
          'userColor': None},
   ...
   20: {  'position': [-140.83518631861594, -9.7981852050721443],
          'useUserColor': False,
          'userColor': None},
   21: {  'position': [51.271000763925741, 121.6745330105898],
          'useUserColor': False,
          'userColor': None},
   22: {  'position': [279.22843577606409, -55.084427047998048],
          'useUserColor': False,
          'userColor': None},
