...
# This file has been generated at Wed Oct 19 16:34:30 2011
...
__all__ = ['_116834960', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'DigitReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', 'GetLocalFiles', '_116836176', 'PlantReconstruction', 'rose_LocalDir2DictOfFiles', 'ReconstructionWithTurtle_ReconstructionWithTurtle', 'rose_geometry_PolygonLeaflet', 'SceneRotation_SceneRotation', '_116836880', 'CanopyReconstruction2011', 'PlantPositionning_PlantPositionning', 'rose_geometry_BuiltBud', 'rose_GridFile2Dict', 'rose_geometry_NoOrgan', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'rose_geometry_RevolutionBud', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', 'GetWebFiles', 'Canopy2011Driver', 'CropGeneration_CropGeneration', 'rose_geometry_BudArray', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'rose_geometry_RawFlower']


_116834960 = DataFactory(name='rose.drf',
...
_116836176 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_116836880 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [-473.26494563423336, 94.946291335855562],
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [-79.203339879697637, -200.21747652186568],
         'useUserColor': False,
         'userColor': None},
   ...
   5: {  'position': [35.499866797311142, -157.71453993256128],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [-119.5656590627099, -48.10531897315424],
         'useUserColor': False,
         'userColor': None},
   7: {  'position': [-188.37089713162212, -169.14476994867408],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [-380.78508909628812, 3.2891495481678312],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [-68.243992939672722, -163.36293483122807],
         'useUserColor': False,
         'userColor': None},
   ...
   13: {  'position': [-109.04894037162521, 103.93590374819951],
          'useUserColor': False,
          'userColor': None},
   14: {  'position': [-215.3016925367007, -49.940310144900494],
          'useUserColor': False,
          'userColor': None},
   15: {  'position': [-123.54798621712861, 24.659050017335097],
          'useUserColor': False,
          'userColor': None},
   16: {  'position': [-71.648309313245448, -14.072491812401235],
          'useUserColor': False,
          'userColor': None},
   ...
   18: {  'position': [-108.87049973427234, 69.281227103627842],
          'useUserColor': False,
          'userColor': None},
   19: {  'position': [41.418588206542708, -43.716383841076208],
          'useUserColor': False,
          'userColor': None},
   20: {  'position': [-113.95855560398967, -16.24146999085206],
          'useUserColor': False,
          'userColor': None},
   ...
   22: {  'position': [-425.19789440214561, 29.488806130969643],
          'useUserColor': False,
          'userColor': None},
   23: {  'position': [0.11455059585241045, -44.378775757190425],
          'useUserColor': False,
          'userColor': None},
   24: {  'position': [-618.14560750325541, 41.447818571996393],
          'useUserColor': False,
          'userColor': None},
   25: {  'position': [-230.48187295955626, -164.32405456571558],
          'useUserColor': False,
          'userColor': None},
   ...
   29: {  'position': [-539.79415787193659, -78.044247904199523],
          'useUserColor': False,
          'userColor': None},
   30: {  'position': [-12.491979847829374, -160.09134637567325],
          'useUserColor': False,
          'userColor': None},
   31: {  'position': [-151.50135142505354, -163.30839281147377],
          'useUserColor': False,
          'userColor': None},
   32: {  'position': [-189.07167293482087, -163.50642835082016],
          'useUserColor': False,
          'userColor': None},
   33: {  'position': [-119.22272403767931, -163.11705481645089],
          'useUserColor': False,
          'userColor': None},
   34: {  'position': [-591.9517656475067, -46.416430375135349],
          'useUserColor': True,
          'userColor': [255, 170, 0]},
   35: {  'position': [-556.6233418052974, -45.942414091833484],
          'useUserColor': True,
          'userColor': [255, 170, 0]},
   36: {  'position': [-98.721168808831408, -164.52144632435994],
          'useUserColor': False,
          'userColor': None},
   37: {  'position': [-614.01624154244598, 4.3799653828629346],
          'useUserColor': False,
          'userColor': None},
   38: {  'position': [-184.09310986093544, -99.79628378884496],
          'useUserColor': False,
          'userColor': None},
   39: {  'position': [-395.01412987323528, -32.12525721333072],
          'useUserColor': False,
          'userColor': None},
   40: {  'position': [-461.19216996171809, 3.4876106417758077],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None},
   '__out__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None}},
