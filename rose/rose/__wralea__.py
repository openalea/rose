...
__all__ = ['drawLeaflets', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_geometry_computeLeaflet4pts', 'RoseLpy', 'roseMtgDataDir', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'rose_geometry_RevolutionBud', 'PlantReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', 'GetLocalFiles', '_123961584', 'DigitReconstruction', 'rose_LocalDir2DictOfFiles', '_123962352', 'rose_geometry_BudArray', 'PlantPositionning_PlantPositionning', '_123962736', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFruit', 'SceneRotation_SceneRotation', 'rose_geometry_PetalMatrix', '_123963120', 'rose_geometry_ReconstructWithTurtle', 'testRevolutionFig', 'CanopyReconstruction2011', 'revolutiontestinonefile_revolutiontestinonefile', 'rose_geometry_BuiltBud', 'drawFlowers', 'rose_GridFile2Dict', 'rose_geometry_RawFlower', 'InputsToRoseLpy_InputsToRoseLpy', 'rose_GetOrigin', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', '_123962224', '_123961616', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', 'GetWebFiles', 'Canopy2011Driver', 'rose_geometry_NoOrgan', 'rose_geometry_TaperedFlower', '_123963216', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'testRevolutionFigCompositeNode', 'rose_geometry_FineBudArray', 'drawBuds', 'CropGeneration_CropGeneration']
...
RoseLpy = CompositeNodeFactory(name='RoseLpy',
                             ...
                             inputs=[],
                             outputs=[],
                             elt_factory={  2: ('Rose', 'growRose.lpy'),
   3: ('Rose', 'inputsperphyto2plt.csv'),
   4: ('Rose', 'inputsperplant2plt.csv'),
   5: ('Rose', 'InputsToRoseLpy'),
   ...
   15: ('Rose', 'growRose.lpy'),
   16: ('Rose', 'inputsperphyto2plt.csv'),
   17: ('Rose', 'inputsperplant2plt.csv'),
   18: ('Rose', 'InputsToRoseLpy'),
   ...
   3: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set([2]),
         'posx': -66.401926413695676,
         'posy': -168.96868505489391,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   9: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 62.835855360103267,
         'posy': -68.465802326082652,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   13: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -4.4006104676199662,
          'posy': 4.8005091345957336,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'useUserColor': False, 'position': [-158.40838299852732, -164.18208485558827], 'userColor': None},
   3: {'useUserColor': False, 'position': [-66.401926413695676, -168.96868505489391], 'userColor': None},
   4: {'useUserColor': False, 'position': [59.908377485374842, -170.36803712816717], 'userColor': None},
   5: {'useUserColor': False, 'position': [5.5078566250567746, -124.72349746253067], 'userColor': None},
   6: {'useUserColor': False, 'position': [124.70851149262754, -137.75176927504785], 'userColor': None},
   7: {'useUserColor': False, 'position': [-120.85636617106657, -47.119885733889731], 'userColor': None},
   8: {'useUserColor': False, 'position': [53.020378126557901, -36.06914964213793], 'userColor': None},
   9: {'useUserColor': False, 'position': [62.835855360103267, -68.465802326082652], 'userColor': None},
   10: {'useUserColor': False, 'position': [115.31479529767452, -6.8806151915920815], 'userColor': None},
   11: {'useUserColor': False, 'position': [50.181612617127399, 53.882508709638486], 'userColor': None},
   12: {'useUserColor': False, 'position': [-4.4185712589575274, 85.272421798339067], 'userColor': None},
   13: {'useUserColor': False, 'position': [-4.4006104676199662, 4.8005091345957336], 'userColor': None},
   14: {'useUserColor': False, 'position': [137.88767921378312, 35.180459542369896], 'userColor': None},
   15: {'useUserColor': False, 'position': [-480.01842016951758, -129.46593173360918], 'userColor': None},
   ...
   18: {'useUserColor': False, 'position': [-315.01926691019963, -78.095294347480404], 'userColor': None},
   19: {'useUserColor': False, 'position': [-198.52589613196324, -96.538134338666282], 'userColor': None},
   20: {'useUserColor': False, 'position': [-424.05687153458325, -19.442671244179937], 'userColor': None},
   21: {'position': [-419.62903384682437, 17.868074989606711], 'userColor': None, 'useUserColor': False},
...
roseMtgDataDir = CompositeNodeFactory(name='roseMtgDataDir',
                             description='gets the name of the MTG data directory of the rose package',
                             category='data i/o',
                             doc='',
                             inputs=[],
                             outputs=[  {  'desc': 'The dir where the MTG data is.',
      'interface': IStr,
      'name': 'datadir'}],
                             elt_factory={  3: ('openalea.file', 'parentdir'),
   4: ('openalea.data structure.string', 'string'),
   5: ('openalea.data structure.string', 'string'),
   6: ('openalea.file', 'joinpath'),
   7: ('openalea.file', 'packagedir'),
   8: ('openalea.data structure.string', 'string')},
                             elt_connections={  6402920: (4, 0, 6, 0),
   6402944: (8, 0, 7, 0),
   6402968: (7, 0, 3, 0),
   6402992: (5, 0, 6, 0),
   6403016: (3, 0, 6, 0),
   6403040: (6, 0, '__out__', 0)},
                             elt_data={  3: {  'block': False,
         'caption': 'parentdir',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3324b90> : "parentdir"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -53.848928591668674,
         'posy': -12.088534989966435,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   4: {  'block': False,
         'caption': "'share'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x47cbdd0> : "string"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 54.054298173899454,
         'posy': -5.2310611136031717,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   5: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 122.63932166336326,
         'posy': -9.8808932145837698,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   6: {  'block': False,
         'caption': 'joinpath',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3324950> : "joinpath"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 8.7184351893386207,
         'posy': 47.660779035051121,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   7: {  'block': False,
         'caption': 'packagedir',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3324f90> : "packagedir"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -60.003821723938429,
         'posy': -45.490100623377359,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -42.135271817142083,
         'posy': -79.16728982402698,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 21.738092268508261,
                 'posy': 85.531357324305304,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [-72.328158613215862, -47.985443512726363],
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [-53.848928591668674, -12.088534989966435],
         'useUserColor': False,
         'userColor': None},
   4: {  'position': [54.054298173899454, -5.2310611136031717],
         'useUserColor': False,
         'userColor': None},
   5: {  'position': [122.63932166336326, -9.8808932145837698],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [8.7184351893386207, 47.660779035051121],
         'useUserColor': False,
         'userColor': None},
   7: {  'position': [-60.003821723938429, -45.490100623377359],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [-42.135271817142083, -79.16728982402698],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None},
   '__out__': {  'position': [21.738092268508261, 85.531357324305304],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
_123961584 = DataFactory(name='rose.drf',
...
_123962352 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_123962736 = DataFactory(name='inputsperplant.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_123963120 = DataFactory(name='inputsperphyto2plt.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   34: ('Rose', 'roseMtgDataDir'),
   35: ('Rose', 'drawLeaflets'),
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [174.18875569049845, 27.636038280071929],
         'useUserColor': False,
         'userColor': None},
   ...
   7: {  'position': [-188.37089713162212, -169.14476994867408],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [263.11848797223041, -18.464455296296872],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [-117.4198895575162, -168.06928299705677],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [-27.650826342126521, 123.00747936130651],
          'useUserColor': False,
          'userColor': None},
   ...
   15: {  'position': [-168.26402965432865, 31.102334803114985],
          'useUserColor': False,
          'userColor': None},
   16: {  'position': [148.24407925599684, 86.394008086052921],
          'useUserColor': False,
          'userColor': None},
   17: {  'position': [13.957922576273631, 33.052629586425709],
          'useUserColor': False,
          'userColor': None},
   ...
   21: {  'position': [62.443561002532476, 122.60557969714034],
          'useUserColor': False,
          'userColor': None},
   22: {  'position': [232.14407477050702, -85.550778286887891],
          'useUserColor': False,
          'userColor': None},
   23: {  'position': [-23.417190233291279, -49.085123923019154],
          'useUserColor': False,
          'userColor': None},
   24: {  'position': [211.85005949355309, -128.65749282626666],
          'useUserColor': False,
          'userColor': None},
   ...
   26: {  'position': [-108.55953911314603, -11.158327328125409],
          'useUserColor': False,
          'userColor': None},
   27: {  'position': [93.904984654798298, -17.373354869700549],
          'useUserColor': False,
          'userColor': None},
   28: {  'position': [139.28428772903985, -87.692030742592848],
          'useUserColor': False,
          'userColor': None},
   29: {  'position': [268.1845872664436, 26.888546061706208],
          'useUserColor': False,
          'userColor': None},
   30: {  'position': [20.838755736201051, 68.270601468442194],
          'useUserColor': False,
          'userColor': None},
   31: {  'position': [-205.13710122354044, -168.01474097730252],
          'useUserColor': False,
          'userColor': None},
   32: {  'position': [72.840555131929094, -54.187078679370373],
          'useUserColor': False,
          'userColor': None},
   33: {  'position': [-175.08840042648799, -167.82340298227959],
          'useUserColor': False,
          'userColor': None},
   34: {  'position': [-87.33712420225811, -169.33697970326719],
          'useUserColor': False,
          'userColor': None},
   35: {  'position': [170.7962114907462, -55.393365888890543],
          'useUserColor': False,
          'userColor': None},
   36: {  'position': [-152.35691860731836, -168.11283119502784],
          'useUserColor': False,
          'userColor': None},
   37: {  'position': [148.44326709179697, -172.01674328151819],
          'useUserColor': False,
          'userColor': None},
...
drawFlowers = CompositeNodeFactory(name='drawFlowers',
   ...
   9: {  'position': [-53.156918921739489, -96.013399618634139],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [-21.369125149942697, -52.738628143365787],
                'useUserColor': True,
...
_123962224 = DataFactory(name='growRose.lpy',
...
_123961616 = DataFactory(name='inputsperphyto.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_123963216 = DataFactory(name='inputsperplant2plt.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
testRevolutionFigCompositeNode = CompositeNodeFactory(name='testRevolutionFigCompositeNode',
   ...
   '__out__': {  'block': False,
         ...
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [61.333499733019607, 45.421506877755085],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None},
   '__out__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None}},
...
drawBuds = CompositeNodeFactory(name='drawBuds',
   ...
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 35.421470170386691,
                 'posy': 68.053682123053761,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   7: {  'position': [124.55287960949508, -142.16865012520782],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [86.168045360518818, -47.425823415479336],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [31.322610526888745, -106.61486508691911],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [35.421470170386691, 68.053682123053761],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
