...
# This file has been generated at Wed Sep 21 13:23:40 2011
...
__all__ = ['httpDir2DictOfFiles_httpDir2DictOfFiles', 'mesh_roseLeaflet_mesh_roseLeaflet', 'MTG_union_MTG_union', 'RoseLpy', 'PlantFrame_Rose_PlantFrame_Rose', '_62154192', 'PlantReconstruction', 'httpFileList_httpFileList', 'LocalDir2DictOfFiles_LocalDir2DictOfFiles', 'GetLocalFiles', 'DigitReconstruction', '_62153616', 'GetMTG_GetMTG', 'NoLeaflet_NoLeaflet', 'SceneRotation_SceneRotation', '_62154320', 'computeLeaflet4pts_computeLeaflet4pts', 'CanopyReconstruction2011', 'PlantPositionning_PlantPositionning', 'CropGeneration_2011_CropGeneration_2011', '_62155344', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', '_62155088', 'ReconstructionWithTurtle_ReconstructionWithTurtle', 'GetWebFiles', '_62154768', 'CropGeneration_CropGeneration', 'tortue_tortue', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'VertexVisitor_VertexVisitor', '_62154704', 'gridFile2Dict_gridFile2Dict', 'Files2MTGs_Files2MTGs']
...
_62154192 = DataFactory(name='21052010_BFV.txt',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
GetLocalFiles = CompositeNodeFactory(name='GetLocalFiles',
   ...
   10: ('Rose', 'LocalDir2DictOfFiles')},
                             elt_connections={  6402896: ('__in__', 0, 8, 1),
   6402920: (5, 0, 6, 0),
   6402944: (8, 0, 5, 0),
   6402968: (6, 0, 10, 0),
   6402992: (7, 0, 8, 0),
   6403016: (10, 0, '__out__', 0),
   6403040: ('__in__', 1, 5, 0)},
                             elt_data={  5: {  'block': False,
         'caption': 'joinpath',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x36d7dd0> : "joinpath"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 31.057076995096743,
         'posy': -167.06126932364518,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         'caption': '+',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x27c9fd0> : "+"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 46.01779933960718,
         'posy': -122.54187888410866,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   9: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -44.807248015563559,
         'posy': -30.86226323142488,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   10: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x14ab31d0> : "LocalDir2DictOfFiles"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 45.890689011599875,
          'posy': 30.976215082829917,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 87.432645420181956,
                'posy': -187.44573803071071,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 93.449003948293822,
                 'posy': 92.357950573439552,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   7: {'useUserColor': False, 'position': [31.057076995096743, -167.06126932364518], 'userColor': None},
   8: {'useUserColor': False, 'position': [46.01779933960718, -122.54187888410866], 'userColor': None},
   9: {'useUserColor': False, 'position': [-44.807248015563559, -30.86226323142488], 'userColor': None},
   10: {'position': [45.890689011599875, 30.976215082829917], 'userColor': None, 'useUserColor': False},
   '__in__': {'useUserColor': False, 'position': [87.432645420181956, -187.44573803071071], 'userColor': None},
   '__out__': {'useUserColor': False, 'position': [93.449003948293822, 92.357950573439552], 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_62153616 = DataFactory(name='2011-M1-PARfort-P3.txt',
...
_62154320 = DataFactory(name='rose.drf',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   26: ('openalea.math', '+')},
                             elt_connections={  6402536: (26, 0, 14, 0),
   6402560: (2, 0, 4, 1),
   6402584: (24, 0, 22, 0),
   6402608: (9, 0, 22, 1),
   6402632: (11, 0, 10, 1),
   ...
   6403040: (22, 0, 26, 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b46410> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b46890> : "ReconstructionWithTurtle"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x5d08150> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'GetWebFiles',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3b468d0> : "GetWebFiles"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -186.79725994987095,
         'posy': -69.404389395327925,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -144.3611723440271,
         'posy': -179.58877546028651,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3761190> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': 'filename',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3741290> : "filename"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x46c4a10> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b463d0> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b46a90> : "gridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b46790> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'tuple',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3c7c950> : "tuple"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   17: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -197.58064388699472,
          'posy': -114.99904447611561,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b46ad0> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 51.206734044222088,
          'posy': -109.21596964794337,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x46c4cd0> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   21: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -89.395689058755394,
          'posy': -104.88717358817976,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   23: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 54.320540783747603,
          'posy': -65.453962995202062,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   5: [(0, "'*.mtg'")],
   6: [],
   7: [(0, "'sagah-043'"), (1, "'/MTG/Manip1_C1_PARfort/P2'"), (2, "'.mtg'")],
   ...
   7: {'useUserColor': False, 'position': [-186.79725994987095, -69.404389395327925], 'userColor': None},
   8: {'useUserColor': False, 'position': [-144.3611723440271, -179.58877546028651], 'userColor': None},
   ...
   14: {'useUserColor': False, 'position': [-285.34730286864931, -27.160808621640015], 'userColor': None},
   ...
   17: {'useUserColor': False, 'position': [-197.58064388699472, -114.99904447611561], 'userColor': None},
   18: {'useUserColor': False, 'position': [-108.87049973427234, 69.281227103627842], 'userColor': None},
   19: {'useUserColor': False, 'position': [51.206734044222088, -109.21596964794337], 'userColor': None},
   20: {'useUserColor': False, 'position': [-32.557267394119066, -64.033398295774049], 'userColor': None},
   21: {'useUserColor': False, 'position': [-89.395689058755394, -104.88717358817976], 'userColor': None},
   22: {'useUserColor': False, 'position': [-297.10930219041825, -115.0268094499621], 'userColor': None},
   23: {'useUserColor': False, 'position': [54.320540783747603, -65.453962995202062], 'userColor': None},
   24: {'useUserColor': False, 'position': [-376.24576717104645, -177.30332434979971], 'userColor': None},
   25: {'useUserColor': False, 'position': [-258.81269394450356, -113.82322816912345], 'userColor': None},
   26: {'useUserColor': False, 'position': [-272.24073465168414, -75.18073567672576], 'userColor': None},
...
_62155344 = DataFactory(name='test2011OK.mtg',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62155088 = DataFactory(name='2011-M1-PARfort-P2.txt',
...
GetWebFiles = CompositeNodeFactory(name='GetWebFiles',
   ...
   6402896: (8, 0, 9, 0),
   6402920: (9, 0, 10, 0),
   6402944: ('__in__', 1, 9, 1),
   6402968: ('__in__', 0, 8, 1),
   ...
   6403040: (10, 0, 5, 0)},
         ...
         'caption': 'print',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x34eea10> : "print"',
         'hide': True,
         'id': 5,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': "'http://'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x374fc10> : "string"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3b195d0> : "httpDir2DictOfFiles"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 101.69076099764357,
                'posy': -283.56174382299349,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 98.291935203827535,
                 'posy': 216.6015498132038,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   10: {  'position': [9.7240316733571568, 48.472699188800377],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [101.69076099764357, -283.56174382299349],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [98.291935203827535, 216.6015498132038],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
_62154768 = DataFactory(name='simpleRoseField.lpy',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_62154704 = DataFactory(name='2011-M1-PARfort-P1.txt',
