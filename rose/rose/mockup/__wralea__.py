...
# This file has been generated at Mon Jan  9 15:23:02 2017
...
__all__ = ['drawLeaflets', 'rose_geometry_Flower', '_140661982281168', 'rose_process_RunXV', 'rose_geometry_ReconstructWithTurtle', 'roseMtgDataDir', '_140661982280656', 'rose_geometry_computeLeaflet4pts', 'rose_process_Decode_liste', 'rose_file_readXls', 'rose_CropGeneration_2011', 'rose_MTG_union', 'scene_union', 'testMTGs', '_140661982280848', 'rose_HttpDir2DictOfFiles', '_140661858087888', 'rose_Files2MTGs', 'rose_GetGrid', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'GetLocalFiles', 'rose_geometry_VertexVisitor4CAN02', 'rose_LocalDir2DictOfFiles', '_140661982278352', 'Canopy2011PhotoNames', '_140661982277904', 'rose_file_RootName', 'rose_Files2MTGs4CAN2', 'rose_geometry_RawFruit', 'rose_geometry_PetalMatrix', '_140661982278864', 'CanopyReconstruction2011', 'rose_file_IntSort', 'CanopyReconstructionWithCan02', 'rose_file_scene2Can01', 'rose_geometry_BuiltBud', 'drawFlowers', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFlower', 'rose_geometry_NoOrgan', 'GetWebFiles', 'rose_geometry_ReconstructionsWithTurtle', 'rose_geometry_RevolutionBud', 'drawBuds', 'rose_geometry_RevolutionFig', 'rose_GetOrigin', 'ChooseOnePlant', 'iterOnce', 'rose_geometry_BudArray', 'rose_geometry_BezierPatchFlower', 'Canopy2011Filenames', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'rose_geometry_FineBudArray', 'rose_file_readCsv']
...
_140661982281168 = CompositeNodeFactory(name='Manip+Prel_to_listOfPhotosID',
...
_140661982280656 = CompositeNodeFactory(name='rose_reconstruction',
...
scene_union = Factory(name='scene_union',
...
_140661982280848 = CompositeNodeFactory(name='test_Polhemus_frame',
...
_140661858087888 = CompositeNodeFactory(name='roses_Can2_Reconstruction',
   ...
   27: {'position': [3.4029602047203866, -2.6304769482618795], 'userColor': None, 'useUserColor': False},
   ...
   37: {'position': [20.252859087056002, 112.37070203140752], 'userColor': None, 'useUserColor': False},
   38: {'position': [-169.92540764861027, 158.64129854694474], 'userColor': None, 'useUserColor': False},
   39: {'position': [-46.938950652055965, 75.94770188105268], 'userColor': None, 'useUserColor': False},
   '__in__': {'useUserColor': True, 'position': [-123.8433106004843, -232.30305362714358], 'userColor': [170, 85, 0]},
   '__out__': {'useUserColor': True, 'position': [-106.76755744747622, 262.19981967578804], 'userColor': [170, 85, 0]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_140661982278352 = CompositeNodeFactory(name='Manip+Prel_to_listOfID',
...
_140661982277904 = CompositeNodeFactory(name='display_photos',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
...
_140661982278864 = CompositeNodeFactory(name='convert_SFMtGs_ToCanFiles',
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   36: ('openalea.data structure.list', 'list')},
                             elt_connections={  14598176: (7, 3, 26, 0),
   14598200: (26, 0, 15, 4),
   14598224: (28, 0, 7, 2),
   14598248: (17, 0, 30, 0),
   14598272: (19, 0, 15, 5),
   ...
   11: {  'position': [136.05881918803203, -6.987927660042473],
          'useUserColor': False,
          'userColor': None},
   12: {  'position': [67.80302231114935, 216.7437115469655],
          'useUserColor': False,
          'userColor': None},
...
CanopyReconstructionWithCan02 = CompositeNodeFactory(name='CanopyReconstructionWithCan02',
   ...
   36: ('openalea.data structure.list', 'list')},
                             elt_connections={  37290088: (6, 0, 15, 1),
   37290112: (10, 0, 12, 0),
   37290136: (7, 0, 14, 0),
   37290160: (36, 0, 28, 0),
   37290184: (19, 0, 15, 5),
   ...
   10: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set([]),
          'posx': -140.29879496430686,
          'posy': 151.03695615128998,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  6: {'useUserColor': False, 'position': [-202.80129680355253, -25.493916834493277], 'userColor': None},
   7: {'useUserColor': False, 'position': [-234.2925623178391, -93.90978313864956], 'userColor': None},
   10: {'useUserColor': False, 'position': [-140.29879496430686, 151.03695615128998], 'userColor': None},
   12: {'useUserColor': False, 'position': [-120.77242530425481, 189.8467193556399], 'userColor': None},
   ...
   33: {'useUserColor': False, 'position': [-0.35694397482258466, 41.07083192446774], 'userColor': None},
   34: {'useUserColor': False, 'position': [-161.82724960660278, 79.61900680644855], 'userColor': None},
   35: {'position': [-169.2647865549652, 115.17429989618921], 'userColor': None, 'useUserColor': False},
