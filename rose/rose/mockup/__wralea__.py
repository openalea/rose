...
# This file has been generated at Mon Mar 19 09:43:59 2012
...
roseMtgDataDir = CompositeNodeFactory(name='roseMtgDataDir',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'position': [-42.675461482915154, 43.424153789632946], 'userColor': None, 'useUserColor': False},
   3: {'position': [-113.39360290953195, -54.580709985996918], 'userColor': None, 'useUserColor': False},
   4: {'position': [-119.34431910764286, -93.026522482721674], 'userColor': None, 'useUserColor': False},
   6: {'position': [-7.1822039844075292, -12.519373400225936], 'userColor': None, 'useUserColor': False},
   7: {'position': [60.221650594916284, -11.527343243779026], 'userColor': None, 'useUserColor': False},
   10: {'useUserColor': False, 'position': [-113.01173939941646, -13.808723754725762], 'userColor': None},
   11: {'useUserColor': False, 'position': [-128.54796492628523, -137.66717307216484], 'userColor': None},
   '__in__': {'position': [0, 0], 'userColor': None, 'useUserColor': True},
   '__out__': {'position': [-28.435350950467239, 81.749281295652906], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_74349648 = DataFactory(name='rose.drf',
