...
# This file has been generated at Fri Nov 28 16:21:23 2014
...
__all__ = ['drawLeaflets', 'rose_geometry_VertexVisitor', 'rose_process_RunXV', 'rose_geometry_ReconstructWithTurtle', 'rose_HttpDir2DictOfFiles', 'roseMtgDataDir', 'rose_geometry_computeLeaflet4pts', 'iterOnce', 'rose_CropGeneration_2011', 'rose_MTG_union', 'testMTGs', 'rose_geometry_Flower', '_64669264', 'rose_Files2MTGs', 'rose_GetGrid', '_64669200', 'rose_geometry_RawBud', 'GetLocalFiles', 'rose_LocalDir2DictOfFiles', '_63233616', 'rose_file_RootName', 'rose_geometry_RawFruit', 'rose_geometry_PetalMatrix', 'CanopyReconstruction2011', 'rose_file_IntSort', 'rose_file_scene2Can01', 'rose_geometry_BuiltBud', 'drawFlowers', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFlower', 'rose_geometry_NoOrgan', 'GetWebFiles', 'rose_geometry_RevolutionBud', 'drawBuds', 'rose_geometry_RevolutionFig', 'rose_GetOrigin', 'convertMtgToCanFiles', 'ChooseOnePlant', 'rose_geometry_BudArray', 'rose_geometry_BezierPatchFlower', 'Canopy2011Filenames', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'rose_geometry_FineBudArray', 'rose_file_readCsv', '_64670032']
...
_64669264 = CompositeNodeFactory(name='Manip+Prel_to_listOfID',
...
_64669200 = CompositeNodeFactory(name='test_Polhemus_frame',
...
_63233616 = CompositeNodeFactory(name='display_photos',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
...
_64670032 = CompositeNodeFactory(name='rose_reconstruction',
   ...
   39: ('openalea.data structure', 'float')},
                             elt_connections={  6402680: (8, 0, 34, 0),
   6402704: (11, 0, 35, 3),
   6402728: (27, 0, 35, 4),
   6402752: (26, 0, 9, 0),
   6402776: ('__in__', 0, 22, 0),
   6402800: (34, 0, 13, 0),
   6402824: (12, 0, 11, 1),
   6402848: (33, 0, 35, 2),
   6402872: (7, 0, 9, 1),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': -252.56840036619471,
                'posy': -180.09007920545716,
                'priority': 0,
                'use_user_color': True,
                'user_application': None,
                'user_color': 170},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': -246.48693177403382,
                 'posy': 208.09091916605044,
                 'priority': 0,
                 'use_user_color': True,
                 'user_application': None,
                 'user_color': 170}},
   ...
   6: {  'position': [-494.89500979136869, 350.40805172601432],
         'useUserColor': False,
         'userColor': None},
   7: {'position': [-156.41099414653303, -39.271057008115548], 'userColor': None, 'useUserColor': False},
   8: {'position': [-120.5546409641299, -140.00808935202411], 'userColor': None, 'useUserColor': False},
   9: {'position': [-189.15932393107903, -0.74751132831920231], 'userColor': None, 'useUserColor': False},
   ...
   13: {'position': [-126.26257650732325, -5.2468455632642499], 'userColor': None, 'useUserColor': False},
   ...
   21: {  'position': [-365.94877246509009, 70.919030528120004],
          'useUserColor': False,
          'userColor': None},
   22: {'position': [-306.68727815513762, 113.06582173625735], 'userColor': None, 'useUserColor': False},
   23: {  'position': [-383.95493325362719, 255.51827957393402],
          'useUserColor': False,
          'userColor': None},
   24: {'position': [-95.697553331181098, -43.724682836347256], 'userColor': None, 'useUserColor': False},
   25: {  'position': [-319.01114067928467, 433.58955562219217],
          'useUserColor': False,
          'userColor': [170, 170, 0]},
   26: {'position': [-238.57621098997822, -66.730795820594238], 'userColor': None, 'useUserColor': False},
   ...
   31: {  'position': [-282.78138402288698, 117.7214526121943],
          'useUserColor': False,
          'userColor': None},
   33: {'position': [-88.672591348761458, -136.60063964797439], 'userColor': None, 'useUserColor': False},
   34: {'position': [-168.25834909204804, -97.999065924448772], 'userColor': None, 'useUserColor': False},
   35: {'position': [-137.65548863697566, 52.192932800245167], 'userColor': None, 'useUserColor': False},
   36: {  'position': [-377.40068192796673, 118.12562532780368],
          'useUserColor': True,
          'userColor': [170, 170, 0]},
   37: {  'position': [-382.27054625741516, -11.047493421184868],
   ...
   53: {  'position': [-455.2167279456765, 74.6322482931444],
          'useUserColor': False,
          'userColor': None},
   '__in__': {'useUserColor': True, 'position': [-252.56840036619471, -180.09007920545716], 'userColor': [170, 85, 0]},
   '__out__': {'useUserColor': True, 'position': [-246.48693177403382, 208.09091916605044], 'userColor': [170, 85, 0]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
