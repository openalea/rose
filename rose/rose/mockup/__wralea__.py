...
# This file has been generated at Mon Nov  6 15:31:50 2017
...
__all__ = ['drawLeaflets', '_139755078590352', 'rose_process_RunXV', 'rose_geometry_ReconstructWithTurtle', 'rose_geometry_computeLeaflet4pts', 'rose_process_Decode_liste', 'iterOnce', 'rose_CropGeneration_2011', 'rose_MTG_union', 'testMTGs', 'rose_geometry_Flower', 'rose_HttpDir2DictOfFiles', '_139755078588880', 'rose_Files2MTGs', 'rose_GetGrid', 'rose_geometry_NoOrgan', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'GetLocalFiles', 'rose_geometry_VertexVisitor4CAN02', '_139755078590032', 'rose_LocalDir2DictOfFiles', 'Canopy2011PhotoNames', 'rose_file_RootName', 'rose_geometry_scene_union', 'rose_geometry_RawFruit', 'rose_geometry_PetalMatrix', '_139755078590096', '_139755077891088', '_139755078590288', 'CanopyReconstruction2011', 'rose_file_IntSort', 'CanopyReconstructionWithCan02', 'drawFlowers', 'rose_file_scene2Can01', 'rose_geometry_BuiltBud', 'rose_Files2MTGs4CAN2', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFlower', 'roseMtgDataDir', 'GetWebFiles', 'rose_geometry_ReconstructionsWithTurtle', 'rose_geometry_RevolutionBud', 'rose_file_readCsv', 'rose_geometry_RevolutionFig', 'rose_GetOrigin', 'ChooseOnePlant', 'rose_file_readXls', 'rose_geometry_BudArray', 'rose_geometry_BezierPatchFlower', 'Canopy2011Filenames', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'rose_geometry_FineBudArray', 'drawBuds', '_139755078588688']
...
_139755078590352 = CompositeNodeFactory(name='display_photos',
                             description='',
...
testMTGs = CompositeNodeFactory(name='testMTGs',
   ...
   21: {  'position': [-115.68019311506849, -111.69490850772047],
          'useUserColor': True,
          'userColor': [255, 170, 0]},
   22: {'position': [-330.55183240887436, 69.95286772409627], 'userColor': None, 'useUserColor': False},
   ...
   34: {  'position': [-41.35264750373429, -102.723516500464],
          'useUserColor': False,
          'userColor': None},
   35: {'useUserColor': False, 'position': [-414.7662810586046, -24.58656741444109], 'userColor': None},
...
_139755078588880 = CompositeNodeFactory(name='rose_reconstruction',
   ...
   39: ('openalea.data structure', 'float')},
                             elt_connections={  36524200: (22, 0, '__out__', 0),
   36524224: (11, 0, 35, 3),
   36524248: (7, 0, 9, 1),
   36524272: (34, 0, 13, 0),
   36524296: (9, 0, 35, 0),
   36524320: ('__in__', 0, 22, 0),
   36524344: (24, 0, 13, 1),
   36524368: (11, 0, 35, 4),
   36524392: (39, 0, 22, 2),
   36524416: (13, 0, 35, 1),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set([]),
                'posx': -206.28293172162296,
                'posy': -71.08577949614023,
                'priority': 0,
                'use_user_color': True,
                'user_application': None,
                'user_color': 170},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set([]),
                 'posx': -168.2837111202408,
                 'posy': 250.43184772914196,
                 'priority': 0,
                 'use_user_color': True,
                 'user_application': None,
                 'user_color': 170}},
   ...
   53: {  'position': [-455.2167279456765, 74.6322482931444],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [-206.28293172162296, -71.08577949614023],
                'useUserColor': True,
                'userColor': [170, 85, 0]},
   '__out__': {  'position': [-168.2837111202408, 250.43184772914196],
                 'useUserColor': True,
                 'userColor': [170, 85, 0]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
_139755078590032 = CompositeNodeFactory(name='roses_Can2_Reconstruction',
...
_139755078590096 = CompositeNodeFactory(name='Manip+Prel_to_listOfID',
...
_139755077891088 = CompositeNodeFactory(name='test_Polhemus_frame',
...
_139755078590288 = CompositeNodeFactory(name='convert_SFMtGs_ToCanFiles',
...
_139755078588688 = CompositeNodeFactory(name='Manip+Prel_to_listOfPhotosID',
