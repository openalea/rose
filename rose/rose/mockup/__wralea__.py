...
# This file has been generated at Tue Mar 13 12:11:55 2012
...
__all__ = ['drawLeaflets', 'mesh_roseLeaflet_mesh_roseLeaflet', 'HybridReconstruction', 'rose_geometry_computeLeaflet4pts', 'rose_CropGeneration_2011', 'rose_MTG_union', 'rose_geometry_BezierPatchFlower', 'PlantFrame_Rose_PlantFrame_Rose', 'rose_HttpDir2DictOfFiles', 'DigitReconstruction', 'rose_Files2MTGs', 'rose_GetMTG', 'rose_geometry_RawBud', 'rose_geometry_VertexVisitor', 'rose_geometry_PointArray', 'GetLocalFiles', 'PlantReconstruction', 'rose_LocalDir2DictOfFiles', 'PlantPositionning_PlantPositionning', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFruit', 'SceneRotation_SceneRotation', 'rose_geometry_PetalMatrix', 'rose_geometry_ReconstructWithTurtle', 'testRevolutionFig', 'CanopyReconstruction2011', 'revolutiontestinonefile_revolutiontestinonefile', 'rose_geometry_BuiltBud', 'drawFlowers', 'rose_GridFile2Dict', 'rose_geometry_RawFlower', 'rose_geometry_NoOrgan', 'rose_GetOrigin', 'Leaflet_Orientation_4points_Leaflet_Orientation_4points', 'rose_geometry_RevolutionBud', 'rose_geometry_RevolutionFig', 'rose_geometry_ControlPointsMatrix', 'GetWebFiles', 'Canopy2011Driver', 'rose_geometry_TaperedFlower', 'rose_geometry_BudArray', 'leaflet_orientation_leaflet_orientation', 'CanopyReconstruction', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'testRevolutionFigCompositeNode', 'rose_geometry_FineBudArray', 'drawBuds', 'CropGeneration_CropGeneration', '_100735376']
...
HybridReconstruction = CompositeNodeFactory(name='HybridReconstruction',
                             ...
                             inputs=[],
                             outputs=[],
                             elt_factory={  3: ('Rose.mockup', 'GetMTG'),
   4: ('openalea.data structure.string', 'string'),
   5: ('openalea.data structure.string', 'string'),
   6: ('Rose.mockup', 'ComputeLeaflet4pts'),
   7: ('Rose.mockup', 'VertexVisitor'),
   8: ('vplants.plantgl.visualization', 'plot3D'),
   9: ('vplants.plantgl.visualization', 'plot3D'),
   10: ('Rose.mockup', 'PlantFrame_Rose'),
   11: ('Rose.mockup', 'rose.drf'),
   12: ('openalea.data structure.list', 'list'),
   13: ('openalea.data structure.list', 'list'),
   14: ('Rose.mockup', 'mesh_roseLeaflet'),
   15: ('Rose.mockup', 'leaflet_orientation'),
   16: ('openalea.math', '+'),
   17: ('Rose.mockup', 'ReconstructWithTurtle')},
   ...
   8: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -87.3067393144598,
         'posy': 85.24876598541883,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   7: {  'position': [-104.32337603275795, -34.137954493924106],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [-87.3067393144598, 85.24876598541883],
         'useUserColor': False,
         'userColor': None},
...
DigitReconstruction = CompositeNodeFactory(name='DigitReconstruction',
   ...
   3: ('Rose.mockup', 'GetMTG'),
   4: ('Rose.mockup', '21052010_BFV.txt'),
   5: ('Rose.mockup', 'PlantReconstruction'),
...
PlantReconstruction = CompositeNodeFactory(name='PlantReconstruction',
   ...
   {  'desc': '', 'interface': None, 'name': 'mesh leaflet', 'value': None}],
                             ...
                             elt_factory={  2: ('Rose.mockup', 'leaflet_orientation'),
   3: ('openalea.math', '+'),
   4: ('Rose.mockup', 'SceneRotation'),
   5: ('Rose.mockup', 'PlantFrame_Rose'),
   6: ('Rose.mockup', 'rose.drf')},
...
testRevolutionFig = CompositeNodeFactory(name='testRevolutionFig',
                             ...
                             inputs=[],
                             outputs=[],
                             elt_factory={  2: ('Rose.mockup', 'RevolutionFig'),
   3: ('Rose.mockup', 'PointArray'),
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [9.74598903888926, 8.619631041931715],
         'useUserColor': False,
         'userColor': None},
...
CanopyReconstruction2011 = CompositeNodeFactory(name='CanopyReconstruction2011',
   ...
   38: ('Rose.mockup', 'Canopy2011Driver')},
                             elt_connections={  6402248: (8, 0, 2, 4),
   6402272: (11, 0, 2, 2),
   6402296: (35, 0, 11, 0),
   6402320: (15, 0, 18, 0),
   6402344: (28, 0, 2, 1),
   ...
   6403040: (6, 0, 15, 1)},
         ...
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x39f68d0> : "VertexVisitor"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 174.18875569049845,
         'posy': 27.63603828007193,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a130d0> : "GetLocalFiles"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -183.23607851764464,
         'posy': -39.43210759705261,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         'caption': 'RawFruit',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x39f6990> : "RawFruit"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 263.1184879722304,
   ...
   9: {  'block': False,
         'caption': '2',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x471f550> : "int"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'pickle dump',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3bcb510> : "pickle dump"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
          'posx': -27.65082634212652,
   ...
   11: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x2816610> : "getitem"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4712890> : "plot3D"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'MTG_union',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x39f6690> : "MTG_union"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x39f6bd0> : "GridFile2Dict"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -206.5147189729787,
          'posy': -71.51568472467886,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x39f64d0> : "CropGeneration_2011"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': 'ReconstructWithTurtle',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x39f6b50> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 148.24407925599684,
          'posy': 86.39400808605292,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   17: {  'block': False,
          'caption': "'canopy.pf'",
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x471ff50> : "string"',
          'hide': True,
          'id': 17,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 13.957922576273631,
          'posy': 33.05262958642571,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   18: {  'block': False,
          'caption': 'Files2MTGs',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x39f6610> : "Files2MTGs"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -132.40224056341603,
          'posy': 64.57487893779913,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   19: {  'block': False,
          'caption': 'True',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x471f310> : "bool"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 17.88684737739908,
          'posy': -48.42273200690494,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   20: {  'block': False,
          'caption': 'list',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3682e10> : "list"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -140.83518631861594,
          'posy': -9.798185205072144,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   21: {  'block': False,
          'caption': 'pickle load',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3bcb290> : "pickle load"',
          'hide': True,
          'id': 21,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   24: {  'block': False,
          'caption': 'drawFlowers',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x39f6d10> : "drawFlowers"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 211.8500594935531,
   ...
   25: {  'block': False,
          'caption': 'drawBuds',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x3a13310> : "drawBuds"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   26: {  'block': False,
          'caption': 'GetOrigin',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x39f6e10> : "GetOrigin"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -108.55953911314603,
          'posy': -11.15832732812541,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   27: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 93.9049846547983,
          'posy': -17.37335486970055,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   29: {  'block': False,
          'caption': '4.20',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x471f3d0> : "float"',
          'hide': True,
          'id': 29,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   30: {  'block': False,
          'caption': 'tempFile',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x3a13210> : "tempFile"',
          'hide': True,
          'id': 30,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 20.83875573620105,
          'posy': 68.2706014684422,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   32: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x38f8d50> : "drawLeaflets"',
          'hide': True,
          'id': 32,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 72.8405551319291,
          'posy': -54.18707867937037,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   33: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -175.088400426488,
          'posy': -167.8234029822796,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   34: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x39f6590> : "roseMtgDataDir"',
          'hide': True,
          'id': 34,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -87.33712420225811,
          'posy': -169.3369797032672,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   38: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x39f6ed0> : "Canopy2011Driver"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -206.50988739491825,
          'posy': -114.5373016111215,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [174.18875569049845, 27.63603828007193],
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [-202.12534771727044, -205.0506516789843],
         'useUserColor': False,
         'userColor': None},
   4: {  'position': [-290.99251516508514, 147.27860016544926],
         'useUserColor': False,
         'userColor': None},
   5: {  'position': [35.49986679731114, -157.71453993256128],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [-183.23607851764464, -39.43210759705261],
         'useUserColor': False,
         'userColor': None},
   7: {  'position': [-188.37089713162212, -169.14476994867408],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [263.1184879722304, -18.464455296296872],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [-117.4198895575162, -168.06928299705677],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [-27.65082634212652, 123.00747936130651],
          'useUserColor': False,
          'userColor': None},
   11: {  'position': [190.95166190370927, -16.773460179630476],
          'useUserColor': False,
          'userColor': None},
   12: {  'position': [197.45712075334114, 131.25354733563196],
          'useUserColor': False,
          'userColor': None},
   13: {  'position': [-132.58068120076885, 99.22955558237075],
          'useUserColor': False,
          'userColor': None},
   14: {  'position': [-206.5147189729787, -71.51568472467886],
          'useUserColor': False,
          'userColor': None},
   15: {  'position': [-168.26402965432865, 31.102334803114985],
          'useUserColor': False,
          'userColor': None},
   16: {  'position': [148.24407925599684, 86.39400808605292],
          'useUserColor': False,
          'userColor': None},
   17: {  'position': [13.957922576273631, 33.05262958642571],
          'useUserColor': False,
          'userColor': None},
   18: {  'position': [-132.40224056341603, 64.57487893779913],
          'useUserColor': False,
          'userColor': None},
   19: {  'position': [17.88684737739908, -48.42273200690494],
          'useUserColor': False,
          'userColor': None},
   20: {  'position': [-140.83518631861594, -9.798185205072144],
          'useUserColor': False,
          'userColor': None},
   21: {  'position': [62.443561002532476, 122.60557969714034],
          'useUserColor': False,
          'userColor': None},
   22: {  'position': [232.14407477050702, -85.55077828688789],
          'useUserColor': False,
          'userColor': None},
   23: {  'position': [-23.41719023329128, -49.085123923019154],
          'useUserColor': False,
          'userColor': None},
   24: {  'position': [211.8500594935531, -128.65749282626666],
          'useUserColor': False,
          'userColor': None},
   25: {  'position': [126.98317010617595, -127.67820418923124],
          'useUserColor': False,
          'userColor': None},
   26: {  'position': [-108.55953911314603, -11.15832732812541],
          'useUserColor': False,
          'userColor': None},
   27: {  'position': [93.9049846547983, -17.37335486970055],
          'useUserColor': False,
          'userColor': None},
   28: {  'position': [139.28428772903985, -87.69203074259285],
          'useUserColor': False,
          'userColor': None},
   29: {  'position': [268.1845872664436, 26.888546061706208],
          'useUserColor': False,
          'userColor': None},
   30: {  'position': [20.83875573620105, 68.2706014684422],
          'useUserColor': False,
          'userColor': None},
   31: {  'position': [-205.13710122354044, -168.01474097730252],
          'useUserColor': False,
          'userColor': None},
   32: {  'position': [72.8405551319291, -54.18707867937037],
          'useUserColor': False,
          'userColor': None},
   33: {  'position': [-175.088400426488, -167.8234029822796],
          'useUserColor': False,
          'userColor': None},
   34: {  'position': [-87.33712420225811, -169.3369797032672],
          'useUserColor': False,
          'userColor': None},
   35: {  'position': [170.7962114907462, -55.39336588889054],
          'useUserColor': False,
          'userColor': None},
   36: {  'position': [-152.35691860731836, -168.11283119502784],
          'useUserColor': False,
          'userColor': None},
   37: {  'position': [148.44326709179697, -172.0167432815182],
          'useUserColor': False,
          'userColor': None},
...
drawFlowers = CompositeNodeFactory(name='drawFlowers',
   ...
   7: ('Rose.mockup', 'TaperedFlower'),
   8: ('Rose.mockup', 'PetalMatrix')},
                             elt_connections={  6402752: (3, 0, '__out__', 0),
   6402776: ('__in__', 0, 2, 3),
   6402800: (6, 0, 2, 1),
   6402824: (8, 0, 2, 0),
   6402848: (4, 0, '__out__', 0),
   6402872: ('__in__', 0, 7, 3),
   6402896: (2, 0, '__out__', 0),
   ...
   6403040: (8, 0, 7, 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b08c50> : "BezierPatchFlower"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'RawFlower',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b19310> : "RawFlower"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'NoOrgan',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b08b10> : "NoOrgan"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': '8',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x483a690> : "int"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 127.25995386655703,
         'posy': -63.52660205206446,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   7: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b192d0> : "TaperedFlower"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'PetalMatrix',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b08ed0> : "PetalMatrix"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 87.44768577130895,
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': -21.369125149942697,
                'posy': -52.73862814336579,
                'priority': 0,
                'use_user_color': True,
                'user_application': None,
                'user_color': 255},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': -17.43266298197091,
                 'posy': -1.7473998506194732,
                 'priority': 0,
                 'use_user_color': True,
                 'user_application': None,
                 'user_color': 255}},
   ...
   5: {  'position': [103.60166285446122, -121.20294333413273],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [127.25995386655703, -63.52660205206446],
         'useUserColor': False,
         'userColor': None},
   7: {  'position': [145.81074384585287, -17.232178818146245],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [87.44768577130895, -149.77895935817781],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [-53.15691892173949, -96.01339961863414],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [-21.369125149942697, -52.73862814336579],
                'useUserColor': True,
                'userColor': [255, 255, 127]},
   '__out__': {  'position': [-17.43266298197091, -1.7473998506194732],
                 'useUserColor': True,
                 'userColor': [255, 255, 127]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
Canopy2011Driver = CompositeNodeFactory(name='Canopy2011Driver',
   ...
   13: ('openalea.math', '+'),
   14: ('openalea.math', '+')},
                             elt_connections={  15333016: (8, 0, 14, 1),
   15333040: ('__in__', 3, 11, 1),
   15333064: (14, 0, '__out__', 2),
   15333088: (9, 0, '__out__', 3),
   15333112: (11, 0, 8, 1),
   15333136: (7, 0, 4, 0),
   15333160: (2, 0, 13, 1),
   15333184: (10, 0, 13, 0),
   15333208: (7, 0, 9, 0),
   15333232: ('__in__', 1, 10, 1),
   15333256: ('__in__', 0, 10, 0),
   15333280: (2, 0, 14, 0),
   15333304: ('__in__', 4, 7, 0),
   15333328: (4, 0, '__out__', 0),
   15333352: (6, 0, 9, 1),
   15333376: (14, 0, 7, 1),
   15333400: (12, 0, 4, 1),
   15333424: ('__in__', 2, 11, 0),
   15333448: (7, 0, '__out__', 1),
   15333472: (13, 0, 8, 0)},
                             elt_data={  2: {  'block': False,
         'caption': "'/'",
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x5949850> : "string"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': '+',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4f5ead0> : "+"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x58a3e90> : "getitem"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 227.99286178218256,
                 'posy': 403.3871905206132,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   11: {  'position': [115.44766501715497, -45.161636239104816],
          'useUserColor': False,
          'userColor': None},
   12: {  'position': [97.22848847474768, 207.99266183967373],
          'useUserColor': False,
          'userColor': None},
   ...
   14: {  'position': [147.44101073087526, 101.09462339139411],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [195.49286178218253, -272.39691806190115],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [227.99286178218256, 403.3871905206132],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
CanopyReconstruction = CompositeNodeFactory(name='CanopyReconstruction',
   ...
   10: ('Rose.mockup', 'ReconstructWithTurtle'),
   ...
   18: ('Rose.mockup', 'PolygonLeaflet'),
   19: ('Rose.mockup', 'NoOrgan')},
                             elt_connections={  27117304: (3, 0, 6, 1),
   27117328: (5, 0, 6, 0),
   27117352: (14, 0, 16, 0),
   27117376: (2, 0, 10, 2),
   27117400: (7, 0, 10, 1),
   ...
   27117664: (10, 0, 8, 0)},
         ...
         'caption': '2.5',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x519eb90> : "float"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'list',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4aac790> : "list"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'MTG',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x56bb610> : "MTG"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'computeLeaflet4pts',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x60113d0> : "ComputeLeaflet4pts"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'VertexVisitor',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x6011650> : "VertexVisitor"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'plot3D',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x7187d50> : "plot3D"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -105.21123714537728,
         'posy': 98.78140096799125,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   9: {  'block': False,
         'caption': 'glob',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x4a91890> : "glob"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'ReconstructWithTurtle',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x60118d0> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -154.25692932565184,
          'posy': 38.35117027433335,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   11: {  'block': False,
          'caption': '.../P1',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x4a91050> : "dirname"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': "'*.mtg'",
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x67e0f90> : "string"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'getitem',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x6768610> : "getitem"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          'caption': '1',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x519ed10> : "int"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 201.31217883290824,
          'posy': -135.313026611923,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   15: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 251.4355744117485,
          'posy': -86.61778938940307,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   16: {  'block': False,
          'caption': '+',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x5a7ff50> : "+"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 203.4837972789759,
          'posy': -84.81533598509654,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   18: {  'block': False,
          'caption': 'PolygonLeaflet',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x60117d0> : "PolygonLeaflet"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   19: {  'block': False,
          'caption': 'NoOrgan',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x6011b10> : "NoOrgan"',
          'hide': True,
          'id': 19,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'position': [-25.567446849555555, -33.23768090442222], 'userColor': None, 'useUserColor': False},
   3: {'useUserColor': True, 'position': [-193.94542610922454, -168.65029807639615], 'userColor': [255, 170, 0]},
   4: {'position': [76.91390220471244, -5.34695576824204], 'userColor': None, 'useUserColor': False},
   5: {'useUserColor': True, 'position': [-228.55474109745128, -168.4052055057154], 'userColor': [255, 170, 0]},
   6: {'position': [-261.13926336519967, -126.45253267734243], 'userColor': None, 'useUserColor': False},
   7: {'position': [-122.39645638076145, -34.25025524712414], 'userColor': None, 'useUserColor': False},
   8: {'position': [-105.21123714537728, 98.78140096799125], 'userColor': None, 'useUserColor': False},
   9: {'position': [99.41602953233658, -81.38410767166513], 'userColor': None, 'useUserColor': False},
   10: {'position': [-154.25692932565184, 38.35117027433335], 'userColor': None, 'useUserColor': False},
   ...
   14: {'position': [201.31217883290824, -135.313026611923], 'userColor': None, 'useUserColor': False},
   15: {'position': [251.4355744117485, -86.61778938940307], 'userColor': None, 'useUserColor': False},
   16: {'position': [203.4837972789759, -84.81533598509654], 'userColor': None, 'useUserColor': False},
   17: {'position': [-119.52213659004252, -70.30713917061324], 'userColor': None, 'useUserColor': False},
   18: {'position': [-143.09045208185142, -166.59816920958417], 'userColor': None, 'useUserColor': False},
   19: {'position': [-44.316907872562965, -116.75800727963701], 'userColor': None, 'useUserColor': False},
   20: {  'position': [-292.32114231325187, -4.26124114159259],
          'useUserColor': False,
          'userColor': None},
   ...
   22: {  'position': [-232.66376633095558, 44.316907872562965],
          'useUserColor': False,
          'userColor': None},
   23: {  'position': [-246.29973798405194, -49.43039724247408],
          'useUserColor': False,
          'userColor': None},
   24: {  'position': [-230.10702164600005, 3.408992913274073],
          'useUserColor': False,
          'userColor': None},
...
testRevolutionFigCompositeNode = CompositeNodeFactory(name='testRevolutionFigCompositeNode',
                             ...
                             inputs=[],
                             outputs=[],
                             elt_factory={  2: ('Rose.mockup', 'revolutiontestinonefile'),
   ...
   '__out__': {  'block': False,
                 ...
                 'user_color': None}},
                             ...
                             elt_ad_hoc={  2: {  'position': [14.885900259467036, -1.6682480192729798],
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [61.33349973301961, 45.421506877755085],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None},
   '__out__': {  'position': [0, 0], 'useUserColor': True, 'userColor': None}},
...
drawBuds = CompositeNodeFactory(name='drawBuds',
   ...
   8: ('Rose.mockup', 'RevolutionFig')},
                             elt_connections={  6402848: (3, 0, 8, 0),
   6402872: (6, 0, 3, 0),
   6402896: (7, 0, 3, 0),
   6402920: (8, 0, 5, 0),
   6402944: ('__in__', 0, 2, 0),
   6402968: (2, 0, '__out__', 0),
   6402992: (4, 0, '__out__', 0),
   6403016: (5, 0, '__out__', 0),
   6403040: ('__in__', 0, 8, 1)},
                             elt_data={  2: {  'block': False,
         'caption': 'BuiltBud',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b19190> : "BuiltBud"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'getitem',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x1e94650> : "getitem"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   5: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b19410> : "RevolutionBud"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'budArray',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b19590> : "budArray"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x3b19510> : "fineBudArray"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'RevolutionFig',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x62d4410> : "RevolutionFig"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 86.16804536051882,
         'posy': -47.425823415479336,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 31.322610526888745,
                'posy': -106.61486508691911,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': 35.42147017038669,
                 'posy': 68.05368212305376,
                 'priority': 0,
                 'use_user_color': False,
                 'user_application': None,
                 'user_color': None}},
   ...
   3: {  'position': [102.34698933445478, -95.6513919013596],
         'useUserColor': False,
         'userColor': None},
   4: {  'position': [-96.84485965562814, -12.713224819657745],
         'useUserColor': False,
         'userColor': None},
   ...
   7: {  'position': [124.55287960949508, -142.16865012520782],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [86.16804536051882, -47.425823415479336],
         'useUserColor': False,
         'userColor': None},
   '__in__': {  'position': [31.322610526888745, -106.61486508691911],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [35.42147017038669, 68.05368212305376],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
_100735376 = DataFactory(name='rose.drf',
