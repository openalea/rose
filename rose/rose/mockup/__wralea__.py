...
# This file has been generated at Fri Feb  2 15:23:00 2018
...
__all__ = ['drawLeaflets', 'rose_geometry_VertexVisitor', 'rose_process_RunXV', 'rose_geometry_ReconstructWithTurtle', 'rose_HttpDir2DictOfFiles', 'roseMtgDataDir', 'rose_geometry_computeLeaflet4pts', 'rose_geometry_BudArray', 'iterOnce', '_140142924286800', 'rose_CropGeneration_2011', 'rose_MTG_union', 'testMTGs', 'rose_geometry_Flower', '_140142924285008', 'rose_Files2MTGs', 'rose_GetGrid', 'rose_geometry_NoOrgan', 'rose_geometry_RawBud', '_140142924284752', 'GetLocalFiles', 'rose_geometry_VertexVisitor4CAN02', 'rose_LocalDir2DictOfFiles', '_140142924287248', 'Canopy2011PhotoNames', 'rose_file_RootName', 'rose_geometry_scene_union', 'rose_geometry_RawFruit', 'rose_geometry_PetalMatrix', 'rose_geometry_drawKnops', 'CanopyReconstruction2011', 'rose_geometry_RevolutionFig', 'rose_file_IntSort', 'CanopyReconstructionWithCan02', 'drawFlowers', 'rose_file_scene2Can01', 'rose_geometry_BuiltBud', 'rose_Files2MTGs4CAN2', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFlower', '_140142924286288', 'rose_GetOrigin', 'rose_geometry_ReconstructionsWithTurtle', 'rose_geometry_RevolutionBud', 'drawBuds', '_140142924285264', 'GetWebFiles', 'ChooseOnePlant', 'rose_file_readXls', 'rose_process_Decode_liste', 'rose_geometry_BezierPatchFlower', 'Canopy2011Filenames', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'rose_geometry_FineBudArray', 'rose_file_readCsv', '_140142924287440']
...
_140142924286800 = CompositeNodeFactory(name='roses_Can2_Reconstruction',
   ...
   39: ('openalea.data structure', 'float')},
                             elt_connections={  6963248: (33, 0, 36, 2),
   6963272: (35, 0, 32, 0),
   6963296: (24, 0, 13, 1),
   6963320: (36, 0, 38, 1),
   6963344: (12, 0, 11, 1),
   6963368: (9, 0, 36, 0),
   6963392: (7, 0, 9, 1),
   6963416: ('__in__', 1, 37, 0),
   6963440: (37, 0, 38, 3),
   6963464: ('__in__', 0, 38, 0),
   6963488: (8, 0, 34, 0),
   6963512: (11, 0, 36, 3),
   6963536: (32, 0, 36, 5),
   6963560: (34, 0, 13, 0),
   ...
   37: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set([]),
          'posx': -62.41757711913549,
          'posy': 150.04330587220363,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   38: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set([]),
          'posx': -167.8324852130105,
          'posy': 193.17451873434118,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set([]),
                'posx': -115.92785921410045,
                'posy': 120.57114596068475,
                'priority': 0,
                'use_user_color': True,
                'user_application': None,
                'user_color': 170},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set([]),
                 'posx': -106.02784618155498,
                 'posy': 250.0108961269978,
                 'priority': 0,
                 'use_user_color': True,
                 'user_application': None,
                 'user_color': 170}},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  7: {'position': [-156.41099414653303, -39.27105700811555], 'userColor': None, 'useUserColor': False},
   8: {'position': [-120.5546409641299, -140.00808935202411], 'userColor': None, 'useUserColor': False},
   9: {'position': [-189.15932393107903, -0.7475113283192023], 'userColor': None, 'useUserColor': False},
   11: {'position': [-69.38097792929176, -1.8624709182894463], 'userColor': None, 'useUserColor': False},
   12: {'position': [-35.15427277905025, -40.959167916830964], 'userColor': None, 'useUserColor': False},
   13: {'position': [-126.26257650732325, -5.24684556326425], 'userColor': None, 'useUserColor': False},
   24: {'position': [-95.6975533311811, -43.724682836347256], 'userColor': None, 'useUserColor': False},
   26: {'position': [-238.57621098997822, -66.73079582059424], 'userColor': None, 'useUserColor': False},
   27: {'position': [82.91284793760916, -47.71340298237406], 'userColor': None, 'useUserColor': False},
   29: {'position': [-26.334773759870174, -171.06281577424684], 'userColor': None, 'useUserColor': False},
   31: {'position': [28.852859977901453, -40.82075298390828], 'userColor': None, 'useUserColor': False},
   32: {'position': [-4.754412156618528, -0.6559643353356179], 'userColor': None, 'useUserColor': False},
   33: {'position': [-88.67259134876146, -136.6006396479744], 'userColor': None, 'useUserColor': False},
   34: {'position': [-168.25834909204804, -97.99906592444877], 'userColor': None, 'useUserColor': False},
   35: {'position': [36.88603039154631, -133.60939897382337], 'userColor': None, 'useUserColor': False},
   36: {'position': [-196.96220670380103, 75.74258102678671], 'userColor': None, 'useUserColor': False},
   37: {'position': [-62.41757711913549, 150.04330587220363], 'userColor': None, 'useUserColor': False},
   38: {'position': [-167.8324852130105, 193.17451873434118], 'userColor': None, 'useUserColor': False},
   39: {'position': [-46.938950652055965, 75.94770188105268], 'userColor': None, 'useUserColor': False},
   '__in__': {'useUserColor': True, 'position': [-115.92785921410045, 120.57114596068475], 'userColor': [170, 85, 0]},
   '__out__': {'useUserColor': True, 'position': [-106.02784618155498, 250.0108961269978], 'userColor': [170, 85, 0]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
testMTGs = CompositeNodeFactory(name='testMTGs',
   ...
   40: ('openalea.data structure.list', 'list')},
                             elt_connections={  33394976: (15, 0, 37, 0),
   33395000: (36, 0, 10, 0),
   33395024: (10, 0, 38, 0),
   33395048: (2, 0, 4, 0),
   33395072: (4, 0, 3, 2),
...
_140142924285008 = CompositeNodeFactory(name='rose_reconstruction',
   ...
   39: ('openalea.data structure', 'float')},
                             elt_connections={  24350816: (36, 0, 37, 1),
   24350840: (12, 0, 11, 1),
   24350864: (9, 0, 35, 0),
   24350888: (37, 0, 35, 5),
   24350912: ('__in__', 0, 22, 0),
   24350936: (11, 0, 35, 4),
   24350960: (35, 0, 22, 1),
   24350984: (24, 0, 13, 1),
   24351008: (11, 0, 35, 3),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set([]),
                'posx': -117.88284870581226,
                'posy': 88.94485265672269,
                'priority': 0,
                'use_user_color': True,
                'user_application': None,
                'user_color': 170},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set([]),
                 'posx': -110.91020895421455,
                 'posy': 190.21418512293113,
                 'priority': 0,
                 'use_user_color': True,
                 'user_application': None,
                 'user_color': 170}},
   ...
   53: {  'position': [-455.2167279456765, 74.6322482931444],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [-117.88284870581226, 88.94485265672269],
                'useUserColor': True,
                'userColor': [170, 85, 0]},
   '__out__': {  'position': [-110.91020895421455, 190.21418512293113],
                 'useUserColor': True,
                 'userColor': [170, 85, 0]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
_140142924284752 = CompositeNodeFactory(name='Manip+Prel_to_listOfID',
...
_140142924287248 = CompositeNodeFactory(name='display_photos',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
...
_140142924286288 = CompositeNodeFactory(name='convert_SFMtGs_ToCanFiles',
...
_140142924285264 = CompositeNodeFactory(name='test_Polhemus_frame',
...
_140142924287440 = CompositeNodeFactory(name='Manip+Prel_to_listOfPhotosID',
