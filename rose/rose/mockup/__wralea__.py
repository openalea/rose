...
# This file has been generated at Wed Mar 28 16:31:22 2012
...
__all__ = ['drawLeaflets', 'rose_geometry_VertexVisitor', 'rose_geometry_ReconstructWithTurtle', 'rose_geometry_computeLeaflet4pts', 'roseMtgDataDir', 'rose_CropGeneration_2011', 'rose_MTG_union', 'testMTGs', 'rose_HttpDir2DictOfFiles', 'rose_Files2MTGs', 'rose_geometry_RawBud', 'Canopy2011Driver', 'GetLocalFiles', 'rose_LocalDir2DictOfFiles', 'rose_geometry_PolygonLeaflet', 'rose_geometry_RawFruit', 'rose_geometry_PetalMatrix', 'CanopyReconstruction2011', 'rose_geometry_BuiltBud', 'drawFlowers', 'rose_GridFile2Dict', 'rose_geometry_RawFlower', 'rose_geometry_NoOrgan', 'GetWebFiles', 'rose_geometry_RevolutionBud', 'rose_geometry_RevolutionFig', 'rose_GetOrigin', 'rose_geometry_BudArray', 'rose_geometry_BezierPatchFlower', 'tempPickleFile_tempPickleFile', 'rose_colors_ColorFuncs', 'rose_geometry_FineBudArray', 'drawBuds']
...
testMTGs = CompositeNodeFactory(name='testMTGs',
   ...
   39: ('openalea.data structure', 'float')},
                             elt_connections={  6402368: (38, 0, 22, 0),
   6402392: (10, 0, 38, 0),
   6402416: (22, 0, 28, 0),
   6402464: (14, 0, 20, 1),
   6402488: (39, 0, 22, 2),
   ...
   6403040: (34, 0, 13, 0)},
         ...
         'caption': '.../2012_02_28',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xaaff550> : "dirname"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'colorFunc',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xc4c09d0> : "colorFunc"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': '0',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x8f06690> : "int"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': -202.82718950424089,
         'posy': -206.4966238060382,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   9: {  'block': False,
         'caption': 'getitem',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xac12ed0> : "getitem"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          'caption': 'print',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xac17150> : "print"',
          'hide': True,
          'id': 10,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          'caption': '+',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xb9b3590> : "+"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          'caption': 'glob',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xaaff950> : "glob"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   16: {  'block': False,
          'caption': "'*.mtg'",
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc2c3dd0> : "string"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   22: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc4c0210> : "ReconstructWithTurtle"',
          'hide': True,
          'id': 22,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   25: {  'block': False,
          'caption': 'plot3D',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc4c7950> : "plot3D"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -136.47548945584833,
          'posy': 161.49599585608721,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   26: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0xc4c00d0> : "drawLeaflets"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   27: {  'block': False,
          'caption': 'RawFruit',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc4c0550> : "RawFruit"',
          'hide': True,
          'id': 27,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   28: {  'block': False,
          'caption': 'scene2can',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xb9dce10> : "scene2can"',
          'hide': True,
          'id': 28,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   29: {  'block': False,
          'caption': 'drawFlowers',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0xc4c0650> : "drawFlowers"',
          'hide': True,
          'id': 29,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   33: {  'block': False,
          'caption': 'PolygonLeaflet',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc4c0510> : "PolygonLeaflet"',
          'hide': True,
          'id': 33,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   34: {  'block': False,
          'caption': 'drawBuds',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0xc4c0a50> : "drawBuds"',
          'hide': True,
          'id': 34,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   35: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc4c01d0> : "VertexVisitor"',
          'hide': True,
          'id': 35,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   38: {  'block': False,
          'caption': 'MTG',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xaeaf5d0> : "MTG"',
          'hide': True,
          'id': 38,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   39: {  'block': False,
          'caption': '2.00',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0xc4c7c10> : "float"',
          'hide': True,
          'id': 39,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   '__out__': {  'block': False,
                 ...
                 'user_application': None,
                 'user_color': None}},
                             elt_value={  5: [(0, "'/home/hautret/developpement/MTG/tests/sepales/2012_02_28'")],
   6: [],
   8: [(0, '0')],
   9: [(1, '0')],
   10: [],
   ...
   20: [],
   21: [(0, '-1')],
   22: [(0, '<openalea.mtg.mtg.MTG object at 0x20374850>')],
   23: [(1, '1')],
   24: [  (  0,
   ...
   6: {'useUserColor': False, 'position': [191.82717891123838, -131.80763213532944], 'userColor': None},
   8: {'useUserColor': False, 'position': [-202.82718950424089, -206.4966238060382], 'userColor': None},
   9: {'useUserColor': False, 'position': [-57.605046607358346, 31.71729391352936], 'userColor': None},
   10: {'useUserColor': False, 'position': [-203.04586418894047, -13.540306590565713], 'userColor': None},
   11: {'useUserColor': False, 'position': [206.9447997721355, -21.675989057769797], 'userColor': None},
   13: {'useUserColor': False, 'position': [82.786927709785743, -30.942646836754491], 'userColor': None},
   14: {'useUserColor': True, 'position': [-165.60012503165632, -109.27646934863529], 'userColor': [255, 170, 0]},
   15: {'useUserColor': False, 'position': [-256.43363800090975, -115.1563348463699], 'userColor': None},
   16: {'useUserColor': False, 'position': [-235.16991830575699, -160.17026708218256], 'userColor': None},
   17: {'useUserColor': True, 'position': [-178.04106126085702, -159.77415997546169], 'userColor': [255, 170, 0]},
   18: {'useUserColor': False, 'position': [202.72987015839809, -93.744457100032136], 'userColor': None},
   20: {'useUserColor': False, 'position': [-215.23302999313222, -49.758558108094448], 'userColor': None},
   21: {'useUserColor': True, 'position': [-114.50333925671734, -111.69490850772047], 'userColor': [255, 170, 0]},
   22: {'useUserColor': False, 'position': [-188.29661733618494, 95.325162526443634], 'userColor': None},
   23: {'useUserColor': False, 'position': [-301.19824085039147, -157.22717797936428], 'userColor': None},
   24: {'useUserColor': False, 'position': [-353.55093496487433, -190.75057590534414], 'userColor': None},
   25: {'useUserColor': False, 'position': [-136.47548945584833, 161.49599585608721], 'userColor': None},
   26: {'useUserColor': False, 'position': [-82.379770084580912, -9.4148308668092433], 'userColor': None},
   27: {'useUserColor': False, 'position': [280.09121828757515, 31.775054175481202], 'userColor': None},
   28: {'useUserColor': False, 'position': [-297.73978381515758, 161.77457757511488], 'userColor': None},
   29: {'useUserColor': False, 'position': [183.58920190278036, -58.842692917557784], 'userColor': None},
   30: {'useUserColor': False, 'position': [-268.45717388899334, 62.017190034080642], 'userColor': None},
   31: {'useUserColor': False, 'position': [-324.02944392377458, 62.511944798312157], 'userColor': None},
   32: {'useUserColor': False, 'position': [-288.97578219029901, 111.0920815657411], 'userColor': None},
   33: {'useUserColor': False, 'position': [91.794600951390152, -168.29010174421529], 'userColor': None},
   34: {'useUserColor': False, 'position': [69.434377642718204, -80.026062367878652], 'userColor': None},
   35: {'useUserColor': False, 'position': [80.026062367878581, 48.251008192397364], 'userColor': None},
   38: {'position': [-172.25129154813902, 43.652724570418798], 'userColor': None, 'useUserColor': False},
   39: {'useUserColor': False, 'position': [-112.47637048259764, 28.183763733098601], 'userColor': None},
...
Canopy2011Driver = CompositeNodeFactory(name='Canopy2011Driver',
   ...
   '__in__': {  'position': [195.49286178218253, -272.39691806190115],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [227.99286178218256, 403.38719052061322],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
drawFlowers = CompositeNodeFactory(name='drawFlowers',
   ...
   8: ('Rose.mockup', 'PetalMatrix')},
                             elt_connections={  6402800: (6, 0, 2, 1),
   6402872: ('__in__', 0, 3, 0),
   6402896: (4, 0, '__out__', 0),
   6402920: ('__in__', 0, 2, 3),
   6402944: (6, 0, 2, 2),
   ...
   6403040: (3, 0, '__out__', 0)},
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xc4c0950> : "BezierPatchFlower"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'RawFlower',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xc4c0750> : "RawFlower"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'NoOrgan',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xc4c0810> : "NoOrgan"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 71.096846774504399,
         'posy': -101.16783340099337,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   8: {  'block': False,
         'caption': 'PetalMatrix',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0xc4c0590> : "PetalMatrix"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 22.322380739035168,
         'posy': -140.21928155527522,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': -10.369125149942697,
                'posy': -100.73862814336579,
                'priority': 0,
                'use_user_color': True,
                'user_application': None,
                'user_color': 255},
   '__out__': {  'block': False,
                 ...
                 'lazy': True,
                 'port_hide_changed': set(),
                 'posx': -1.4326629819709105,
                 'posy': 25.252600149380527,
                 'priority': 0,
                 'use_user_color': True,
                 'user_application': None,
                 'user_color': 255}},
   ...
   5: {  'position': [103.60166285446122, -121.20294333413273],
         'useUserColor': False,
         'userColor': None},
   6: {'position': [71.096846774504399, -101.16783340099337], 'userColor': None, 'useUserColor': False},
   7: {  'position': [145.81074384585287, -17.232178818146245],
         'useUserColor': False,
         'userColor': None},
   8: {'position': [22.322380739035168, -140.21928155527522], 'userColor': None, 'useUserColor': False},
   9: {  'position': [-53.156918921739489, -96.013399618634139],
         'useUserColor': False,
         'userColor': None},
   '__in__': {'useUserColor': True, 'position': [-10.369125149942697, -100.73862814336579], 'userColor': [255, 255, 127]},
   '__out__': {'useUserColor': True, 'position': [-1.4326629819709105, 25.252600149380527], 'userColor': [255, 255, 127]}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
