...
def diffuse(propname, p, pu, pd, pl, diffusioncoef):
...
def process_transport(p, pu = None, pd = None, pl = None, verbose = False):
  ...
  # citokinin
  diffuse('ck', p, pu, pd, pl, P.ck_diffusion_coef)
  
  #strigolactone
  diffuse('sl', p, pu, pd, pl, P.sl_diffusion_coef)
